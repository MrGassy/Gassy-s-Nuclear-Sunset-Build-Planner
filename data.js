...
const ARCHETYPES_DATA = [
  ...
  /* ── 1. WANDERING GUNSLINGER ────────────────────────────── */
  {
    ...
    icon:'🔫', color:'#EF9F27', origin:'MW', mode:'std', buildKarma:'neutral',
    ...
    startingTraits:[{name:'Trigger Discipline'},{name:'Built to Destroy'},{name:'Four Eyes'}],
    traits:['','','','','','','','','','','',''],
    perks:[
    ...
    charLevel:30,
    skillPoints:{"BARTER":86,"BIG GUNS":84,"ENERGY WEAPONS":78,"EXPLOSIVES":5,"GUNS":76,"LOCKPICK":0,"MEDICINE":0,"MELEE WEAPONS":7,"REPAIR":82,"SCIENCE":0,"SNEAK":76,"SPEECH":0,"SURVIVAL":0,"UNARMED":0},
    ...
    skillHistory:[
      ...
      {level:4,allocation:{"GUNS":12,"REPAIR":1},gains:{"GUNS":24,"REPAIR":2},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:5,allocation:{"REPAIR":13},gains:{"REPAIR":26},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      ...
      {level:8,allocation:{"REPAIR":1,"SNEAK":12},gains:{"REPAIR":2,"SNEAK":24},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:9,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:10,allocation:{"MELEE WEAPONS":7,"SNEAK":6},gains:{"MELEE WEAPONS":7,"SNEAK":12},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:11,allocation:{"BARTER":6,"SNEAK":7},gains:{"BARTER":6,"SNEAK":14},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:12,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:13,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:14,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:15,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:16,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:17,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:18,allocation:{"BARTER":2,"BIG GUNS":11},gains:{"BARTER":2,"BIG GUNS":11},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:19,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:20,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:21,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:22,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:23,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:24,allocation:{"BIG GUNS":8,"ENERGY WEAPONS":5},gains:{"BIG GUNS":8,"ENERGY WEAPONS":5},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:25,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:26,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:27,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:28,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:29,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13},
      {level:30,allocation:{"ENERGY WEAPONS":8,"EXPLOSIVES":5},gains:{"ENERGY WEAPONS":8,"EXPLOSIVES":5},tagged:["GUNS","REPAIR","SNEAK"],pointsTotal:13}
    ],
    description:"High AGI and tagged GUNS deliver lethal Bullet Time chains from level 2. Implants push PER to 8 for Desperado and Sniper, AGI to 9 for the deepest AP pool, and LCK to 7 for High Roller. Trigger Discipline tightens spread; Built to Destroy adds crit velocity.",
  },

  /* ── 2. NCR COMMANDO ────────────────────────────────────── */
  {
    id:'commando', name:'NCR Commando', tagline:'Infantry firepower, US Army loadout',
    icon:'🪖', color:'#639922', origin:'MW', mode:'std', buildKarma:'good',
    ...
    startingTraits:[{name:'Trigger Discipline'},{name:'Bloody Mess'},{name:'Dustbowl'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Swift Learner','Bonus XP throughout the campaign'],
      ['ACTION STAR [+TOTAL AP]','Sustained BT fire support'],
      ['Gunslinger','Sidearm accuracy as backup'],
      ['Stonewall','+1 DT vs melee per END; immune to knockdown — STR 7/END 7 ✓ with implants'],
    ...
    charLevel:30,
    skillPoints:{"BARTER":88,"BIG GUNS":80,"ENERGY WEAPONS":78,"EXPLOSIVES":78,"GUNS":78,"LOCKPICK":13,"MEDICINE":0,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":0,"SNEAK":0,"SPEECH":0,"SURVIVAL":80,"UNARMED":0},
    levelUpBonuses:["hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","cw","cw","cw","cw","cw","cw"],
    skillHistory:[
      {level:2,allocation:{"EXPLOSIVES":13},gains:{"EXPLOSIVES":26},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:3,allocation:{"EXPLOSIVES":13},gains:{"EXPLOSIVES":26},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:4,allocation:{"EXPLOSIVES":13},gains:{"EXPLOSIVES":26},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:5,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:6,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:7,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      ...
      {level:11,allocation:{"BARTER":12,"SURVIVAL":1},gains:{"BARTER":12,"SURVIVAL":2},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:12,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:13,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:14,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:15,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:16,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:17,allocation:{"BARTER":11,"BIG GUNS":2},gains:{"BARTER":11,"BIG GUNS":2},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:18,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:19,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:20,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:21,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:22,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:23,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:24,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:25,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:26,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:27,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:28,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:29,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13},
      {level:30,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":13},tagged:["EXPLOSIVES","GUNS","SURVIVAL"],pointsTotal:13}
    ],
    description:"PER 7 and END 6 at base become PER 8 and END 7 via implants, unlocking both Stonewall early and the Full Metal Jacket chain at level 18. Six implant slots (base END 6) cover every key stat. Grunt synergises with the EXPLOSIVES and SURVIVAL tags for a true multi-role infantry soldier.",
  },

  /* ── 3. SHADOW ASSASSIN ─────────────────────────────────── */
  {
    id:'assassin', name:'Shadow Assassin', tagline:'Unseen, unheard, lethal',
    icon:'🗡', color:'#7F77DD', origin:'CW', mode:'std', buildKarma:'evil',
    ...
    charLevel:30,
    skillPoints:{"BARTER":87,"BIG GUNS":83,"ENERGY WEAPONS":66,"EXPLOSIVES":0,"GUNS":75,"LOCKPICK":79,"MEDICINE":0,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":0,"SNEAK":60,"SPEECH":0,"SURVIVAL":33,"UNARMED":0},
    levelUpBonuses:["ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp"],
    skillHistory:[
      {level:2,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:3,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:4,allocation:{"GUNS":12,"LOCKPICK":1},gains:{"GUNS":23,"LOCKPICK":2},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:5,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":26},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:6,allocation:{"LOCKPICK":8,"SNEAK":5},gains:{"LOCKPICK":16,"SNEAK":10},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:7,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":26},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:8,allocation:{"LOCKPICK":5,"SNEAK":8},gains:{"LOCKPICK":9,"SNEAK":16},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:9,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:10,allocation:{"BARTER":9,"SNEAK":4},gains:{"BARTER":9,"SNEAK":8},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:11,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:12,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:13,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:14,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:15,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:16,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:17,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:18,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:19,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:20,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:21,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:22,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:23,allocation:{"BIG GUNS":5,"ENERGY WEAPONS":8},gains:{"BIG GUNS":5,"ENERGY WEAPONS":8},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      ...
      {level:26,allocation:{"ENERGY WEAPONS":6,"SURVIVAL":7},gains:{"ENERGY WEAPONS":6,"SURVIVAL":7},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:27,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:28,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:29,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13},
      {level:30,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","LOCKPICK","SNEAK"],pointsTotal:13}
    ],
    description:"AGI 9 is the highest possible base, giving the most AP and the deepest stealth bonus. Implants push LCK to 9 and PER to 7, unlocking Hobbler and supercharging The Professional crit chain. Four traits all reinforce stealth: Small Frame, Assassin's Step, Bloody Mess, Four Eyes.",
  },

  /* ── 4. ENERGY WEAPONS SPECIALIST ───────────────────────── */
  {
    id:'energy', name:'Energy Weapons Specialist', tagline:'Harness the power of science',
    icon:'⚡', color:'#1D9E75', origin:'MW', mode:'std', buildKarma:'neutral',
    ...
    perks:[
      ...
      ['Jury Rigging','Repair anything with a roughly similar item — INT 7 ✓ with implant'],
    ...
    charLevel:30,
    skillPoints:{"BARTER":87,"BIG GUNS":81,"ENERGY WEAPONS":77,"EXPLOSIVES":21,"GUNS":0,"LOCKPICK":0,"MEDICINE":0,"MELEE WEAPONS":0,"REPAIR":69,"SCIENCE":79,"SNEAK":79,"SPEECH":0,"SURVIVAL":0,"UNARMED":0},
    ...
    skillHistory:[
      ...
      {level:11,allocation:{"BARTER":11,"SNEAK":2},gains:{"BARTER":11,"SNEAK":3},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:12,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:13,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:14,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:15,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:16,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:17,allocation:{"BARTER":11,"BIG GUNS":2},gains:{"BARTER":11,"BIG GUNS":2},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:18,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:19,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:20,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:21,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:22,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:23,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:24,allocation:{"REPAIR":13},gains:{"REPAIR":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:25,allocation:{"REPAIR":13},gains:{"REPAIR":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:26,allocation:{"REPAIR":13},gains:{"REPAIR":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:27,allocation:{"REPAIR":13},gains:{"REPAIR":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:28,allocation:{"REPAIR":13},gains:{"REPAIR":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:29,allocation:{"BIG GUNS":1,"EXPLOSIVES":8,"REPAIR":4},gains:{"BIG GUNS":1,"EXPLOSIVES":8,"REPAIR":4},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13},
      {level:30,allocation:{"EXPLOSIVES":13},gains:{"EXPLOSIVES":13},tagged:["ENERGY WEAPONS","SCIENCE","SNEAK"],pointsTotal:13}
    ],
    description:"PER 8 and LCK 8 at base become LCK 9 via implant — the highest crit foundation in the game. INT implant pushes to 7 unlocking Jury Rigging. Night Person raises INT to 8 at night for even more skill generation. The Laser Commander to Meltdown chain is the late-game payoff.",
  },

  /* ── 5. UNARMED BRAWLER ─────────────────────────────────── */
  {
    id:'brawler', name:'Unarmed Brawler', tagline:'Your fists are the only weapons you need',
    icon:'✊', color:'#D85A30', origin:'CW', mode:'std', buildKarma:'neutral',
    ...
    charLevel:30,
    skillPoints:{"BARTER":95,"BIG GUNS":78,"ENERGY WEAPONS":62,"EXPLOSIVES":0,"GUNS":0,"LOCKPICK":0,"MEDICINE":0,"MELEE WEAPONS":74,"REPAIR":0,"SCIENCE":0,"SNEAK":0,"SPEECH":0,"SURVIVAL":78,"UNARMED":73},
    levelUpBonuses:["hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap"],
    skillHistory:[
      {level:2,allocation:{"MELEE WEAPONS":12},gains:{"MELEE WEAPONS":24},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:3,allocation:{"MELEE WEAPONS":12},gains:{"MELEE WEAPONS":24},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:4,allocation:{"MELEE WEAPONS":12},gains:{"MELEE WEAPONS":24},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:5,allocation:{"MELEE WEAPONS":1,"SURVIVAL":11},gains:{"MELEE WEAPONS":2,"SURVIVAL":22},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:6,allocation:{"SURVIVAL":8,"UNARMED":4},gains:{"SURVIVAL":16,"UNARMED":8},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:7,allocation:{"SURVIVAL":12},gains:{"SURVIVAL":24},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:8,allocation:{"SURVIVAL":8,"UNARMED":4},gains:{"SURVIVAL":16,"UNARMED":8},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      ...
      {level:11,allocation:{"BARTER":7,"UNARMED":5},gains:{"BARTER":7,"UNARMED":9},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:12,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:13,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:14,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:15,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:16,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:17,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:18,allocation:{"BARTER":12},gains:{"BARTER":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:19,allocation:{"BARTER":4,"BIG GUNS":8},gains:{"BARTER":4,"BIG GUNS":8},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:20,allocation:{"BIG GUNS":12},gains:{"BIG GUNS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:21,allocation:{"BIG GUNS":12},gains:{"BIG GUNS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:22,allocation:{"BIG GUNS":12},gains:{"BIG GUNS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:23,allocation:{"BIG GUNS":12},gains:{"BIG GUNS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:24,allocation:{"BIG GUNS":12},gains:{"BIG GUNS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:25,allocation:{"BIG GUNS":10,"ENERGY WEAPONS":2},gains:{"BIG GUNS":10,"ENERGY WEAPONS":2},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:26,allocation:{"ENERGY WEAPONS":12},gains:{"ENERGY WEAPONS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:27,allocation:{"ENERGY WEAPONS":12},gains:{"ENERGY WEAPONS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:28,allocation:{"ENERGY WEAPONS":12},gains:{"ENERGY WEAPONS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:29,allocation:{"ENERGY WEAPONS":12},gains:{"ENERGY WEAPONS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12},
      {level:30,allocation:{"ENERGY WEAPONS":12},gains:{"ENERGY WEAPONS":12},tagged:["MELEE WEAPONS","SURVIVAL","UNARMED"],pointsTotal:12}
    ],
    description:"Seven implant slots (base END 7) cover every SPECIAL stat. Rip N' Tear grants +2 STR and +5 UNARMED instantly, pushing effective STR to 10 for Piercing Strike. PER implant unlocks Better Criticals at level 16. Double Slayer makes late-game unarmed blindingly fast.",
  },

  /* ── 6. WASTELAND SURVIVOR ──────────────────────────────── */
  {
    id:'survivor', name:'Wasteland Survivor', tagline:'Live off the land, outlast everyone',
    icon:'🌵', color:'#5DCAA5', origin:'MW', mode:'std', buildKarma:'neutral',
    ...
    perks:[
      ...
      ['Better Criticals','3% crit damage per PER — PER 7 ✓ with implant'],
      ['Strong Back','+4 lbs carry per STR and END — STR 6 and END 9 ✓ with implants'],
    ...
    charLevel:30,
    skillPoints:{"BARTER":84,"BIG GUNS":76,"ENERGY WEAPONS":80,"EXPLOSIVES":17,"GUNS":84,"LOCKPICK":0,"MEDICINE":80,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":0,"SNEAK":0,"SPEECH":0,"SURVIVAL":76,"UNARMED":0},
    levelUpBonuses:["hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap","ap","ap","ap","ap","cw","cw","cw","cw","cw","cw","cw","cw","cw"],
    skillHistory:[
      {level:2,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:3,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:4,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:5,allocation:{"GUNS":3,"MEDICINE":10},gains:{"GUNS":6,"MEDICINE":20},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:6,allocation:{"MEDICINE":7,"SURVIVAL":6},gains:{"MEDICINE":14,"SURVIVAL":12},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:7,allocation:{"MEDICINE":13},gains:{"MEDICINE":26},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:8,allocation:{"MEDICINE":6,"SURVIVAL":7},gains:{"MEDICINE":12,"SURVIVAL":14},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:9,allocation:{"MEDICINE":4,"SURVIVAL":9},gains:{"MEDICINE":8,"SURVIVAL":18},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:10,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:11,allocation:{"BARTER":10,"SURVIVAL":3},gains:{"BARTER":10,"SURVIVAL":6},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:12,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:13,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:14,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:15,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:16,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:17,allocation:{"BARTER":9,"BIG GUNS":4},gains:{"BARTER":9,"BIG GUNS":4},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:18,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:19,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:20,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:21,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:22,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:23,allocation:{"BIG GUNS":7,"ENERGY WEAPONS":6},gains:{"BIG GUNS":7,"ENERGY WEAPONS":6},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:24,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:25,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:26,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:27,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:28,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:29,allocation:{"ENERGY WEAPONS":9,"EXPLOSIVES":4},gains:{"ENERGY WEAPONS":9,"EXPLOSIVES":4},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13},
      {level:30,allocation:{"EXPLOSIVES":13},gains:{"EXPLOSIVES":13},tagged:["GUNS","MEDICINE","SURVIVAL"],pointsTotal:13}
    ],
    description:"Eight implant slots (base END 8, plus END implant gives 9 total in special but limit stays 8) cover all seven SPECIAL stats. STR implant unlocks Strong Back; PER implant unlocks Hobbler; INT implant unlocks Pack Rat. Atomic! and Rad Child turn radiation into a resource.",
  },

  /* ── 7. EXPLOSIVES DEMOLITIONIST ────────────────────────── */
  {
    id:'demoman', name:'Explosives Demolitionist', tagline:'If in doubt, blow it up',
    icon:'💥', color:'#D4537E', origin:'CW', mode:'std', buildKarma:'neutral',
    ...
    startingTraits:[{name:'Loose Cannon'},{name:'Built to Destroy'},{name:'Bloody Mess'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ...
      ['Duck and Cover','Explosion damage resistance +15%'],
      ['Sniper','Head hit BT +25%; crit +25% scoped and crouched — PER 8 ✓'],
    ...
    charLevel:30,
    skillPoints:{"BARTER":88,"BIG GUNS":84,"ENERGY WEAPONS":78,"EXPLOSIVES":78,"GUNS":78,"LOCKPICK":9,"MEDICINE":0,"MELEE WEAPONS":0,"REPAIR":80,"SCIENCE":0,"SNEAK":0,"SPEECH":0,"SURVIVAL":0,"UNARMED":0},
    ...
    skillHistory:[
      ...
      {level:11,allocation:{"BARTER":12,"REPAIR":1},gains:{"BARTER":12,"REPAIR":2},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:12,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:13,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:14,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:15,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:16,allocation:{"BARTER":13},gains:{"BARTER":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:17,allocation:{"BARTER":11,"BIG GUNS":2},gains:{"BARTER":11,"BIG GUNS":2},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:18,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:19,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:20,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:21,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:22,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:23,allocation:{"BIG GUNS":13},gains:{"BIG GUNS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:24,allocation:{"BIG GUNS":4,"ENERGY WEAPONS":9},gains:{"BIG GUNS":4,"ENERGY WEAPONS":9},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:25,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:26,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:27,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:28,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:29,allocation:{"ENERGY WEAPONS":13},gains:{"ENERGY WEAPONS":13},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13},
      {level:30,allocation:{"ENERGY WEAPONS":4,"LOCKPICK":9},gains:{"ENERGY WEAPONS":4,"LOCKPICK":9},tagged:["EXPLOSIVES","GUNS","REPAIR"],pointsTotal:13}
    ],
    description:"PER implant pushes to 8, unlocking both Sniper and Headhunter as premium late-game picks. AGI implant reaches 8 for Action Star efficiency. EXPLOSIVES, GUNS and REPAIR triple-tagged for a self-sustaining demolitionist who crafts, maintains, and detonates everything.",
  },

  /* ── 8. SILVER-TONGUED MERCENARY ────────────────────────── */
  {
    id:'diplomat', name:'Silver-Tongued Mercenary', tagline:'Words as weapons, caps as armour',
    icon:'💬', color:'#B5D4F4', origin:'MW', mode:'std', buildKarma:'good',
    ...
    startingTraits:[{name:'Good Natured'},{name:'Educated'},{name:'Impartial Mediation'}],
    traits:['','','','','','','','','','','',''],
    perks:[
    ...
    charLevel:30,
    skillPoints:{"BARTER":71,"BIG GUNS":82,"ENERGY WEAPONS":87,"EXPLOSIVES":79,"GUNS":0,"LOCKPICK":0,"MEDICINE":78,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":0,"SNEAK":0,"SPEECH":71,"SURVIVAL":47,"UNARMED":0},
    levelUpBonuses:["cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap"],
    skillHistory:[
      {level:2,allocation:{"BARTER":14},gains:{"BARTER":28},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:3,allocation:{"BARTER":14},gains:{"BARTER":28},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:4,allocation:{"BARTER":8,"MEDICINE":6},gains:{"BARTER":15,"MEDICINE":12},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:5,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:6,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:7,allocation:{"MEDICINE":5,"SPEECH":9},gains:{"MEDICINE":10,"SPEECH":18},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:8,allocation:{"SPEECH":14},gains:{"SPEECH":28},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:9,allocation:{"BIG GUNS":1,"SPEECH":13},gains:{"BIG GUNS":1,"SPEECH":25},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:10,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:11,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:12,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:13,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:14,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:15,allocation:{"BIG GUNS":11,"ENERGY WEAPONS":3},gains:{"BIG GUNS":11,"ENERGY WEAPONS":3},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:16,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:17,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:18,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:19,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:20,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:21,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      ...
      {level:25,allocation:{"EXPLOSIVES":9,"SURVIVAL":5},gains:{"EXPLOSIVES":9,"SURVIVAL":5},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:26,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:27,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:28,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:29,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14},
      {level:30,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["BARTER","MEDICINE","SPEECH"],pointsTotal:14}
    ],
    description:"CHR 8 with Good Natured (+1 CHA) makes an effective 9 for all dialogue. CHA implant deliberately avoided — it would push effective CHA to 10 and block Magnetic Personality (requires CHR < 10). INT implant reaches 8, unlocking maximum skill point generation alongside the Educated trait.",
  },

  /* ── 9. TECH SCAVENGER ──────────────────────────────────── */
  {
    id:'techscav', name:'Tech Scavenger', tagline:'Smarter, not stronger',
    icon:'🔧', color:'#AFA9EC', origin:'CW', mode:'std', buildKarma:'neutral',
    ...
    startingTraits:[{name:'Educated'},{name:'Hoarder'},{name:'Night Person'}],
    traits:['','','','','','','','','','','',''],
    perks:[
    ...
    charLevel:30,
    skillPoints:{"BARTER":87,"BIG GUNS":81,"ENERGY WEAPONS":81,"EXPLOSIVES":32,"GUNS":11,"LOCKPICK":0,"MEDICINE":75,"MELEE WEAPONS":0,"REPAIR":75,"SCIENCE":75,"SNEAK":0,"SPEECH":0,"SURVIVAL":0,"UNARMED":0},
    levelUpBonuses:["cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap"],
    skillHistory:[
      {level:2,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:3,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:4,allocation:{"MEDICINE":10,"REPAIR":4},gains:{"MEDICINE":19,"REPAIR":8},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:5,allocation:{"REPAIR":14},gains:{"REPAIR":28},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:6,allocation:{"GUNS":11,"REPAIR":3},gains:{"GUNS":11,"REPAIR":6},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:7,allocation:{"REPAIR":14},gains:{"REPAIR":28},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:8,allocation:{"REPAIR":3,"SCIENCE":11},gains:{"REPAIR":5,"SCIENCE":22},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:9,allocation:{"SCIENCE":14},gains:{"SCIENCE":28},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:10,allocation:{"BARTER":1,"SCIENCE":13},gains:{"BARTER":1,"SCIENCE":25},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:11,allocation:{"BARTER":14},gains:{"BARTER":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:12,allocation:{"BARTER":14},gains:{"BARTER":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:13,allocation:{"BARTER":14},gains:{"BARTER":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:14,allocation:{"BARTER":14},gains:{"BARTER":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:15,allocation:{"BARTER":14},gains:{"BARTER":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:16,allocation:{"BARTER":14},gains:{"BARTER":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:17,allocation:{"BARTER":2,"BIG GUNS":12},gains:{"BARTER":2,"BIG GUNS":12},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      ...
      {level:20,allocation:{"BIG GUNS":11,"ENERGY WEAPONS":3},gains:{"BIG GUNS":11,"ENERGY WEAPONS":3},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:21,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:22,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:23,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:24,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:25,allocation:{"BIG GUNS":2,"ENERGY WEAPONS":12},gains:{"BIG GUNS":2,"ENERGY WEAPONS":12},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:26,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:27,allocation:{"ENERGY WEAPONS":14},gains:{"ENERGY WEAPONS":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:28,allocation:{"ENERGY WEAPONS":10,"EXPLOSIVES":4},gains:{"ENERGY WEAPONS":10,"EXPLOSIVES":4},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:29,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14},
      {level:30,allocation:{"EXPLOSIVES":14},gains:{"EXPLOSIVES":14},tagged:["MEDICINE","REPAIR","SCIENCE"],pointsTotal:14}
    ],
    description:"INT 9 and LCK 9 give the highest skill-point generation and crit potential of any archetype. LCK implant reaches 10, enabling Winning Streak in future runs. MEDICINE, REPAIR and SCIENCE all triple-tagged and governed by INT means every tagged skill starts at 25 and races to 100.",
  }
];
