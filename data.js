...
const ARCHETYPES_DATA = [
  ...
  {
    id:'gunslinger', name:'The Pistolero', tagline:'Never stops moving. Never stops talking. Never misses.',
    notes:"WEAPONS\nLucky  ·  Maria  ·  Sleepytyme  ·  Wild Bill\'s Sidearm\n\nARMOUR\nGrifter\'s Fit  ·  Leather Rebel  ·  Lucky Shades  ·  Suave Gambler Hat\n\nPLAY STYLE\nFire from the hip while moving. Fast Shot and Hip Shooter mean you never stop to aim and you barely suffer for it. Run n\' Gun halves the movement spread penalty — it is the keystone that makes the whole approach work.\n\nOpen with Scoundrel dialogue where possible. When that fails, keep moving and let the pistol do the talking. Built to Destroy accelerates weapon wear so keep backups.\n\nAvoid two-handed weapons entirely — Right Handed halves your accuracy with them.\n\nRP\nTalks too much for someone with nothing to say, and says exactly the right thing every time. Has never stood still in a fight. Has never shot from cover. Has never missed — or at least refuses to admit it.",
    icon:'🔫', color:'#EF9F27', origin:'MW', mode:'std', buildKarma:'neutral', difficulty:2,
    special:{STR:5,PER:6,END:5,CHA:7,INT:6,AGI:9,LCK:7},
    tags:[false,false,false,false,true,false,false,false,false,false,true,true,false,false],
    startingTraits:[{name:'Fast Shot'},{name:'Hip Shooter'},{name:'Built to Destroy'},{name:'Right Handed'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Swift Learner','+2% XP per INT — INT 4 ✓, PER 4 ✓'],
      ['ACTION STAR [+TOTAL AP]','Deep AP reserves for the longest hip-fire chains — Level 4 ✓, AGL 5 ✓'],
      ['Gunslinger','One-handed accuracy +15% — rank 1'],
      ['Scoundrel','+8% vendor discount, XP from speech checks — CHR 7 ✓ rank 1'],
      ['Quick Draw','Draw speed scales with weapon skill'],
      ['Western Standoff','+25% chance to hit enemy weapon in BT — AGL 5 ✓, Guns 35 ✓'],
      ['Handgun Hotshot','5 DT pen, +15% attack speed with ballistic handguns — Guns 40 ✓'],
      ['Gunslinger','One-handed accuracy +15% — rank 2'],
      ['Better Criticals','3% crit damage per PER — PER 7 ✓ with implant'],
      ['Handgun Hotshot','+20% damage with handguns — rank 2'],
      ['Scoundrel','Discount and speech XP — rank 2'],
      ['Big Iron','+20% draw speed; +35% attack speed for 3 seconds after drawing a handgun — AGL 8 ✓, Guns 60 ✓. The fastest draw in the Mojave.'],
      ['Grim Reaper\'s Sprint','Kill in BT restores 20 AP — LCK 6 ✓'],
      ['Concentrated Fire','BT accuracy compounds each shot on same part'],
      ['Scoundrel','Discount and speech XP — rank 3'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    uniWpns:[false,false,false,false,false,true,false,true,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    uniArmor:[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    charLevel:30,
    skillPoints:{"BARTER":0,"BIG GUNS":0,"ENERGY WEAPONS":0,"EXPLOSIVES":0,"GUNS":77,"LOCKPICK":68,"MEDICINE":80,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":0,"SNEAK":72,"SPEECH":74,"SURVIVAL":0,"UNARMED":0},
    levelUpBonuses:["ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","cw","cw"],
    skillHistory:[
      {level:2,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:3,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:4,allocation:{"GUNS":9,"SNEAK":4},gains:{"GUNS":18,"SNEAK":8},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:5,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:6,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:7,allocation:{"SNEAK":7,"SPEECH":6},gains:{"SNEAK":14,"SPEECH":12},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:8,allocation:{"SPEECH":13},gains:{"SPEECH":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:9,allocation:{"SPEECH":13},gains:{"SPEECH":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:10,allocation:{"SPEECH":9,"MEDICINE":4},gains:{"SPEECH":18,"MEDICINE":4},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:11,allocation:{"MEDICINE":13},gains:{"MEDICINE":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:12,allocation:{"MEDICINE":13},gains:{"MEDICINE":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:13,allocation:{"MEDICINE":13},gains:{"MEDICINE":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:14,allocation:{"MEDICINE":13},gains:{"MEDICINE":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:15,allocation:{"MEDICINE":13},gains:{"MEDICINE":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:16,allocation:{"MEDICINE":11,"GUNS":2},gains:{"MEDICINE":11,"GUNS":4},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:17,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:18,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:19,allocation:{"GUNS":7,"SNEAK":6},gains:{"GUNS":14,"SNEAK":12},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:20,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:21,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:22,allocation:{"SNEAK":3,"LOCKPICK":10},gains:{"SNEAK":6,"LOCKPICK":10},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:23,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:24,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:25,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:26,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":13},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:27,allocation:{"LOCKPICK":6,"GUNS":7},gains:{"LOCKPICK":6,"GUNS":14},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:28,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:29,allocation:{"GUNS":2,"SNEAK":11},gains:{"GUNS":4,"SNEAK":22},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13},
      {level:30,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SPEECH"],pointsTotal:13}
    ],
    description:"CHA 7 with three Scoundrel ranks gives this build a completely different flavour from the Desert Cowboy's revolver romanticism — the Gunslinger talks first, shoots second, and is genuinely good at both. Fast Shot fires faster with increased spread; Hip Shooter (requires Fast Shot ✓) restores +25% hip-fire accuracy, directly offsetting the spread penalty at close-medium range. Run n' Gun halves the remaining movement penalty. The result is a build that fires pistols accurately at full sprint. Right Handed adds +20% one-handed accuracy passively; two-handed weapons are mechanically banned. GUNS, SNEAK, and SPEECH triple-tagged — the three pillars of a grifter who negotiates first and usually doesn't need to shoot.",
  },
  ...
  /* ── 3. SHADOW ASSASSIN ─────────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nA Light Shining in Darkness  ·  Sleepytyme  ·  Christine\'s CoS Silencer Rifle\n\nARMOUR\nChinese Stealth Armor  ·  Assassin Suit  ·  Cryptochromatic Spectacles  ·  Lucky Shades\n\nPLAY STYLE\nNever enter combat undetected. Reposition after every kill. Silenced pistols only — the moment suppression breaks, retreat and reset sneak.\n\nLockpick every locked container before moving on. Caps fund better gear faster than looting bodies. Use the Small Frame and Night Person trait combination to become invisible while crouched and stationary.\n\nRP\nA contractor. No ideology, no faction loyalty above the contract. Collects the payment and vanishes. Speaks rarely and precisely. Will not take a job against children or the innocent — a line, not a philosophy.",
    ...
    startingTraits:[{name:'Small Frame'},{name:"Assassin's Step"},{name:'Night Person'},{name:'Four Eyes'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Thief','Sneak and pickpocket bonuses'],
      ['Thief','+5 Sneak, +5% pickpocket chance — rank 2 — AGL 9 ✓, Sneak 25 ✓'],
    ...
    description:"AGI 9 is the highest possible base. LCK 9 post-implant feeds devastating crit chains. Night Person gives +1 INT and PER after dark — this build is designed to operate at night, so plan rest cycles accordingly. Assassin's Step makes you nearly invisible while crouched and undetected, then punishes exposure with a 12.5% AP boost. LOCKPICK opens every door a target might be behind. MEDICINE and REPAIR keep the build self-sufficient between contracts without ever returning to a vendor. The sole stealth build in the roster — owns the shadows completely.",
  },

  /* ── 5. UNARMED BRAWLER ─────────────────────────────────── */
  {
    id:'brawler', name:'The Pit Fighter', tagline:'No weapons. No mercy. All CW.',
    notes:"WEAPONS\nLove and Hate  ·  Two-Step Goodbye  ·  Pushy  ·  Salt-Upon-Wounds\' Power Fist\n\nARMOUR\nLedoux\'s Hockey Mask  ·  Leather Rebel  ·  Composite Recon Armor  ·  Tribal Power Armor\n\nPLAY STYLE\nClose distance immediately and stay there. Rip N\' Tear gives +2 STR at creation, so the first few levels hit harder than they should.\n\nHot Blooded fires at 50% HP and turns you into a sprint-punching blur. Drop health into that zone intentionally and stay there with careful stimpak timing. Block to build Friction Addiction AP between volleys.\n\nRP\nSettled every argument with their hands before the bombs fell and sees no reason to change now. Cheerful about violence. No grudges — once the fight is done it is done. Has a soft spot for dogs and brahmin.",
    ...
    startingTraits:[{name:"Rip N' Tear"},{name:'Hot Blooded'},{name:'War Child'},{name:'Hurt Me More'}],
    traits:['','','','','','','','','','','',''],
    perks:[
    ...
    description:"The definitive unarmed build — the only one in the roster built for the Capital Wasteland's brutal close-range environment. War Child grants +1 to all SPECIAL in combat, stacking with Rip N' Tear's +2 STR and +5 UNARMED to make the opening punch land at a level that shouldn't exist at character creation. Hot Blooded at 50% HP synergises with Hurt Me More's AP-on-hit to create a feedback loop: getting hit restores AP, which fuels more attacks, which drops HP further into the Hot Blooded window. Piercing Strike negates 2 DT per STR point — at effective STR 11 in combat that's 22 flat DT ignored. Double Slayer rank pushes unarmed attack speed to a point where crowds cannot respond. MELEE WEAPONS invested only enough for Super Slam and Fatal Counter triggers — everything else is punching.",
  },

  /* ── 8. SILVER-TONGUED MERCENARY ────────────────────────── */
  {
    id:'diplomat', name:'Silver-Tongued Mercenary', tagline:'Words as weapons, caps as armour',
    notes:"WEAPONS\nLucky  ·  Maria  ·  Zhu-Rong V418\n\nARMOUR\nBenny\'s Suit  ·  Ambassador Crocker\'s Suit  ·  Lucky Shades  ·  Suave Gambler Hat  ·  Tenpenny\'s Suit\n\nPLAY STYLE\nAttempt a speech check before every combat encounter — you will succeed more than you expect. Keep caps available for Barter leverage.\n\nImpartial Mediation rewards staying neutral, so avoid strong faction commitments early. The weapons are for when words fail, which is rarer than other builds expect.\n\nRP\nA fixer who believes every conflict has a deal inside it waiting to be found. Morally flexible. Likes everyone until they make it impossible. Has a list of people owed favours and people who owe them, kept entirely in memory.",
    ...
    perks:[
      ...
      ['Retention','Skill magazine bonuses last 3x longer — INT 9 ✓ — maximise speech/barter mags before every negotiation'],
  ...
  /* ── 9. TECH SCAVENGER ──────────────────────────────────── */
  {
    id:'techscav', name:'The Gadgeteer', tagline:'Smarter, not stronger',
    notes:"WEAPONS\nWazer Wifle  ·  Smuggler\'s End  ·  Lincoln\'s Repeater\n\nARMOUR\nAll-Purpose Science Suit  ·  Vault Lab Uniform  ·  Dr. Klein\'s Glasses  ·  Dr. Klein\'s Scrubs  ·  Neural Interface Suit\n\nPLAY STYLE\nInvest heavily in Science and Repair early — both compound as the build progresses. Hack every terminal. Disassemble enemy robots for components before moving on.\n\nNight Person means nighttime workbench sessions are the most productive hours. What Are You, Stupid? punishes enemies with lower INT — most raiders qualify.\n\nRP\nThe only person in the wasteland who actually read the manual. Insufferably correct about how things work. Takes notes on everything. Convinced that the wasteland\'s problems are fundamentally engineering problems.",
    ...
    perks:[
      ...
      ['Daddy\'s Boy/Girl','Hacking easier; chem efficiency +10% — rank 1'],
      ['Math Wrath','AP costs reduced 5% per 10 Science above 40; Pip-Vision charges 2× faster — INT 8 ✓'],
  ...
  /* ── 10. PINT-SIZED SLASHER ─────────────────────────────── */
  {
    id:'pslasher', name:'Pint-Sized Slasher', tagline:'The dark has teeth.',
    notes:"WEAPONS\nChance\'s Knife  ·  Blood-Nap  ·  Ripper  ·  Chainsaw\n\nARMOUR\nPint-Sized Slasher Mask  ·  Grifter\'s Fit  ·  Leather Rebel  ·  Armor of the 87th Tribe\n\nPLAY STYLE\nAlways open from stealth. Blade In The Shadow adds flat damage before the sneak crit multiplier fires — the opener hits harder than it has any right to.\n\nOnce combat is live, target limbs. Butcher turns every cripple into restored AP and bonus XP, so aggressive limb targeting actively sustains you. When an enemy runs, they take double damage.\n\nWhen the body drops, the Cannibal trait lets you recover health mid-fight. Ghastly Scavenger extends this to Super Mutants and Feral Ghouls. The Chainsaw unlocks at LVL28 and changes everything — until then, blades only.\n\nRP\nSomething in the head isn\'t right. They don\'t talk much. They don\'t need to. The trail of bodies behind them speaks clearly enough, and the way they crouch over the remains has made even hardened wastelanders look away. The mask stays on.",
    icon:'🔪', color:'#C0392B', origin:'CW', mode:'std', buildKarma:'evil', difficulty:4,
    special:{STR:8,PER:7,END:8,CHA:2,INT:6,AGI:8,LCK:8},
    tags:[false,false,false,false,false,false,false,true,false,false,true,false,true,false],
    startingTraits:[{name:'Cannibal'},{name:'Bloody Mess'},{name:'Hot Blooded'},{name:'Twisted'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Blade In The Shadow','+10 damage out of line-of-sight; +10 more out of combat entirely — Melee 30 ✓, Sneak 30 ✓'],
      ['Death Wish','XP from enemy crits on you — evil karma draws aggression; this turns punishment into fuel'],
      ['Light Step','Mine/trap trigger chance -10% per AGL while sneaking — AGL 8 = -80% — Sneak 40 ✓'],
      ['That\'s Not a Knife','+3 DT per END against bladed weapons; skin toughened by sun and violence — END 8 ✓, Melee 30 ✓, Survival 30 ✓'],
      ['Finesse','+5 effective LCK of crit chance — with LCK 9 via implant every strike is dangerous — AGL 5 ✓'],
      ['Silent Running','Sprint without breaking sneak — rank 1 — AGL 6 ✓, Sneak 50 ✓'],
      ['Mister Sandman','Silent execute sleeping targets for bonus XP — Sneak 50 ✓, AGL 8 ✓'],
      ['Butcher','+20% attack speed with one-handed melee; AP and XP restored on cripple — Evil Karma ✓, Melee 35 ✓'],
      ['Ghastly Scavenger','While sneaking: eat Super Mutant and Feral Ghoul corpses to restore Health — Cannibal ✓, END 8 ✓'],
      ['This Is A Knife','Guard with blade: enemy crit -20%, +5 DT. Rank 2: +10% attack speed, +15% damage — That\'s Not a Knife ✓, STR 6 ✓, AGL 7 ✓, Melee 60 ✓'],
      ['Piercing Strike','Melee and Unarmed negate 2 DT per STR — STR 9 via implant = 18 DT ignored on every hit — STR 7 ✓, Melee 50 ✓'],
      ['Better Criticals','+3% crit damage per PER — PER 8 via implant = +24% on every blade strike — PER 6 ✓, LCK 6 ✓'],
      ['Ninja','+15% crit chance with melee and unarmed; sneak attack criticals deal +25% more damage — Sneak 80 ✓, Melee 80 ✓'],
      ['Chainsaw Carnage','+20% damage with automatic melee; kill = +10 DT for 4 seconds and brief time slow — Butcher ✓'],
      ['Unstoppable Force','4x damage through enemy blocks while moving forward — the wall breaks — STR 7 ✓, Melee 60 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    uniArmor:[false,false,false,false,true,false,false,false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false],
    charLevel:30,
    skillPoints:{"BARTER":0,"BIG GUNS":0,"ENERGY WEAPONS":0,"EXPLOSIVES":0,"GUNS":0,"LOCKPICK":68,"MEDICINE":78,"MELEE WEAPONS":82,"REPAIR":0,"SCIENCE":0,"SNEAK":82,"SPEECH":0,"SURVIVAL":76,"UNARMED":0},
    levelUpBonuses:["hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","cw","cw","cw","cw","cw"],
    skillHistory:[
      {level:2,allocation:{"SNEAK":7,"MELEE WEAPONS":6},gains:{"SNEAK":14,"MELEE WEAPONS":12},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:3,allocation:{"MELEE WEAPONS":13},gains:{"MELEE WEAPONS":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:4,allocation:{"MELEE WEAPONS":13},gains:{"MELEE WEAPONS":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:5,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:6,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:7,allocation:{"SNEAK":8,"SURVIVAL":5},gains:{"SNEAK":16,"SURVIVAL":10},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:8,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:9,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:10,allocation:{"SURVIVAL":3,"MEDICINE":10},gains:{"SURVIVAL":6,"MEDICINE":10},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:11,allocation:{"MEDICINE":13},gains:{"MEDICINE":13},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      ...
      {level:16,allocation:{"MEDICINE":3,"MELEE WEAPONS":10},gains:{"MEDICINE":3,"MELEE WEAPONS":20},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:17,allocation:{"MELEE WEAPONS":13},gains:{"MELEE WEAPONS":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:18,allocation:{"MELEE WEAPONS":13},gains:{"MELEE WEAPONS":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:19,allocation:{"MELEE WEAPONS":4,"SNEAK":9},gains:{"MELEE WEAPONS":8,"SNEAK":18},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:20,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:21,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:22,allocation:{"SNEAK":3,"LOCKPICK":10},gains:{"SNEAK":6,"LOCKPICK":10},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:23,allocation:{"LOCKPICK":13},gains:{"LOCKPICK":13},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      ...
      {level:27,allocation:{"LOCKPICK":8,"SURVIVAL":5},gains:{"LOCKPICK":8,"SURVIVAL":10},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:28,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:29,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:30,allocation:{},gains:{},tagged:["MELEE WEAPONS","SNEAK","SURVIVAL"],pointsTotal:13}
    ],
    description:"MELEE WEAPONS and SNEAK both tagged — blades and shadows. SURVIVAL tagged for That\'s Not a Knife (Survival 30) and the broader wasteland endurance that comes from eating things you shouldn\'t. MEDICINE invested for self-sufficiency: the longer this character goes undetected, the more dangerous they become.",
  },

  /* ── 11. BIG GUNS HEAVY ──────────────────────────────────── */
  {
    id:'heavygunner', name:'The Walking Arsenal', tagline:'When you need a bigger gun',
    notes:"WEAPONS\nCZ57 Avenger  ·  Bozar  ·  Burnmaster  ·  Mercy\n\nARMOUR\nRemnants Power Armor  ·  NCR Ranger Combat Armor  ·  Composite Recon Armor  ·  1st Recon Beret\n\nPLAY STYLE\nGet into position before the fight starts. Big guns have slow draw and heavy ammo consumption — pre-place yourself with the enemy in front and allies to the sides.\n\nHurt Me More flips damage taken into bonuses, so absorbing a hit is not a loss. Ideologue pays out passively for Very Good karma — be genuinely good and the build rewards it mechanically.\n\nRP\nA protector who uses overwhelming force specifically so the people behind them never have to. Collects flowers from grateful settlements and has no idea what to do with them. Carries too much. Complains about it. Carries more.",
    ...
    perks:[
      ...
      ['Size Matters','+20% accuracy, reload, and equip speed with Big Guns — rank 2 of 3'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
  ...
  /* ── 13. PUMP-ACTION RANGER ──────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nDinner Bell  ·  The Terrible Shotgun  ·  The Kneecapper  ·  Riot Shotgun\n\nARMOUR\nDesert Ranger Combat Armor  ·  Wanderer\'s Leather Armor  ·  Cryptochromatic Spectacles  ·  Rebreather\n\nPLAY STYLE\nNever engage beyond 20 metres. Claustrophobia grants +1 to every SPECIAL outdoors, so prioritise open wilderness and use that bonus to maintain Walker Instinct uptime.\n\nTryptophobe rewards every Brahmin Steak and raw bird meat you can scavenge. Survivalist means eating and drinking sates twice as effectively — combined with Dustbowl\'s slow hunger, you stay in the Hardy and Fight Hungry windows almost permanently.\n\nStealth opens the first shot as a sneak-attack crit at point-blank, which tends to end the fight immediately.\n\nRP\nA ranger without a station. Carries the territory inside them instead. Sleeps under the stars by preference. Distrusts any settlement larger than three buildings. Has very strong opinions about shotguns.",
    icon:'🎯', color:'#97C459', origin:'MW', mode:'std', buildKarma:'good', difficulty:2,
    special:{STR:6,PER:8,END:7,CHA:4,INT:6,AGI:8,LCK:7},
    tags:[false,false,false,false,true,false,false,false,false,false,true,false,true,false],
    startingTraits:[{name:'Trigger Discipline'},{name:'Built to Destroy'},{name:'Claustrophobia'},{name:'Tryptophobe'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ...
      ['Hardy','Hunger/thirst >150: +15 Survival, +15% heal — END 5 ✓, Survival 25 ✓'],
      ['Shell Shock','+35% equip, +25% reload speed with shotguns — AGL 6 ✓, Guns 50 ✓'],
      ['Shotgun Surgeon','6 DT pen, -8% spread with shotguns — Guns 45 ✓, PER 6 ✓ rank 1'],
      ['Shotgun Surgeon','6 DT pen, -8% spread — rank 2'],
      ['Quick Draw','Draw speed scales with Guns skill'],
      ['Better Criticals','3% crit damage per PER — PER 8 ✓ with implant'],
      ['Concentrated Fire','BT accuracy stacks per shot on same body part'],
      ['Western Standoff','+25% BT chance to hit enemy weapon — AGL 5 ✓, Guns 35 ✓'],
      ...
      ['Grim Reaper\'s Sprint','Kill in BT restores AP — LCK 6 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    uniWpns:[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,true,false,true,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    uniArmor:[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    charLevel:30,
    skillPoints:{"BARTER":0,"BIG GUNS":0,"ENERGY WEAPONS":0,"EXPLOSIVES":0,"GUNS":78,"LOCKPICK":70,"MEDICINE":78,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":0,"SNEAK":74,"SPEECH":0,"SURVIVAL":78,"UNARMED":0},
    levelUpBonuses:["ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","cw","cw","cw"],
    skillHistory:[
      {level:2,allocation:{"GUNS":7,"SURVIVAL":6},gains:{"GUNS":14,"SURVIVAL":12},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      ...
      {level:5,allocation:{"GUNS":6,"SURVIVAL":7},gains:{"GUNS":12,"SURVIVAL":14},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:6,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:7,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:8,allocation:{"SURVIVAL":2,"SNEAK":11},gains:{"SURVIVAL":4,"SNEAK":22},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      ...
      {level:11,allocation:{"SNEAK":5,"MEDICINE":8},gains:{"SNEAK":10,"MEDICINE":8},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      ...
      {level:17,allocation:{"MEDICINE":3,"GUNS":10},gains:{"MEDICINE":3,"GUNS":20},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:18,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:19,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:20,allocation:{"GUNS":2,"SNEAK":11},gains:{"GUNS":4,"SNEAK":22},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:21,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:22,allocation:{"SNEAK":13},gains:{"SNEAK":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:23,allocation:{"SNEAK":3,"LOCKPICK":10},gains:{"SNEAK":6,"LOCKPICK":10},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      ...
      {level:28,allocation:{"LOCKPICK":8,"GUNS":5},gains:{"LOCKPICK":8,"GUNS":10},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:29,allocation:{"GUNS":13},gains:{"GUNS":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13},
      {level:30,allocation:{"SURVIVAL":13},gains:{"SURVIVAL":26},tagged:["GUNS","SNEAK","SURVIVAL"],pointsTotal:13}
    ],
    description:"GUNS, SNEAK, and SURVIVAL triple-tagged — the shotgunner has nothing to do with machinery or repair. It lives outside, scavenges food, and opens every fight from the dark at bad breath range. Claustrophobia delivers +1 to all SPECIAL outdoors, synergising with Walker Instinct's agility and perception bonuses to create a build that is meaningfully stronger in the field than indoors. Dustbowl slows hunger — combined with Hardy and Fight Hungry this means the build runs at bonuses more often than not. Double Shotgun Surgeon and Shell Shock make every shell land heavier and reload faster. Buck Wild is the endgame: indoors the build becomes terrifying, which is when Claustrophobia stops helping and the shotgun has to carry.",
  },
  ...
  /* ── 14. DESERT COWBOY ───────────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nLucky  ·  Callahan\'s Magnum  ·  Mysterious Magnum  ·  Paulson\'s Revolver\n\nARMOUR\nPaulson\'s Outfit  ·  Regulator Duster  ·  Lucky Shades  ·  Suave Gambler Hat  ·  Sheriff\'s Duster\n\nPLAY STYLE\nRevolvers and lever-actions only. Ideologue pays at Good karma — help people genuinely. Right Handed adds 25% one-handed damage passively so every cowboy shot hits harder from the start.\n\nThe Cowboy perk chain starts stacking at LVL10 and the build becomes markedly more powerful from that point. Carry cigarettes for Boiadero\'s passive crit bonus.\n\nRP\nBelieves the Mojave needs to be the Old West and conducts themselves accordingly. Has a name for every brahmin they meet. Takes insults to their hat personally. Would die for their companion and has said so out loud, which made everyone uncomfortable.",
  ...
  /* ── 15. WASTELAND SNIPER ────────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nGobi Campaign Scout Rifle  ·  Victory Rifle  ·  Ratslayer  ·  Christine\'s CoS Silencer Rifle\n\nARMOUR\nAssassin Suit  ·  Cryptochromatic Spectacles  ·  Boone\'s Beret  ·  Chinese Stealth Armor\n\nPLAY STYLE\nEngage only from concealment and only at maximum range. Careful Handling reduces spread for precision. Four Eyes means glasses must stay on — check your loadout before every major fight.\n\nNight Person fires at night: plan ambushes after dark. Never enter a building as the primary approach if there\'s a window.\n\nRP\nPatient. Methodical. Has been in this exact spot for three hours and is not bothered by that. Keeps a rangefinding log. Dislikes explosions on philosophical grounds. Has a very specific morning routine and gets genuinely irritated when it\'s disrupted.",
    ...
    perks:[
      ...
      ['Friend of the Night','Eyes adapt to low-light; plan operations after dark — PER 7 ✓, Sneak 40 ✓ or Survival 40 ✓'],
...
,
  ...
  /* ── 16. JEKYLL & HYDE ───────────────────────────────────── */
  {
    ...
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Non-Combatant','+8 DT, +15% DR while weapon holstered in combat — no req, sets the Jekyll mode'],
      ...
      ['In Shining Armor','+5 DT vs energy weapons in metal armor; +2 with reflective eyewear — REPAIR 40 ✓, SCIENCE 30 ✓'],
    ...
    notes:"WEAPONS\nElijah\'s Advanced LAER  ·  Q-35 Matter Modulator  ·  Jingwei\'s Shocksword  ·  Oh, Baby!\n\nARMOUR\nNeural Interface Suit  ·  All-Purpose Science Suit  ·  Remnants Power Armor  ·  Gannon Family Tesla Armor\n\nPLAY STYLE\nThe build has two modes — switch deliberately. Energy weapons at range, blade melee when enemies close.\n\nJekyll & Hyde demands INT 8 post-implant so Science and Energy Weapons compound rapidly. Cyborg provides blanket resistances. Invest broadly and both modes sharpen simultaneously.\n\nRP\nA scientist who had a very bad night in a Big Mountain laboratory and came out different. Refers to the melee half as \'the other shift\'. Keeps detailed notes on both personalities\' experiences. The handwriting changes.",
  },
  ...
  /* ── 17. COMPANION COMMANDER ─────────────────────────────── */
  {
    ...
    perks:[
      ...
      ['High Roller','+2% crit chance per 2500 casino chips held, up to +10% — LCK 7 ✓'],
      _EMPTY_PERK_SLOT,
    ],
    implantsTaken:{
      '"Probability Calculator" Luck Implant': true,
    ...
    notes:"WEAPONS\nLucky  ·  Ratslayer  ·  Gobi Campaign Scout Rifle  ·  Maria\n\nARMOUR\nPaulson\'s Outfit  ·  Lucky Shades  ·  Viva Las Vegas  ·  Suave Gambler Hat\n\nPLAY STYLE\nBullet Time is the primary damage tool. Lucky\'s crit chains fuel Grim Reaper\'s Sprint, which keeps BT extended. Mysterious Stranger fires randomly but at LCK 10 he appears constantly.\n\nMagnate rewards holding large cap stacks — visit casinos early and often. The crit loop becomes self-sustaining by LVL20.\n\nRP\nConvinced they are cosmically favoured. Flips a coin for major decisions. Has won every coin flip they\'ve ever described to anyone. Whether this is genuine luck or selective memory is unclear. Always leaves the casino ahead.",
  }
,
  ...
  /* ── 19. ATOMIC GHOUL ────────────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nEuclid\'s C-Finder  ·  YCS/186  ·  Jingwei\'s Shocksword  ·  Bumper Sword\n\nARMOUR\nRadiation Suit  ·  Rebreather  ·  Neural Interface Suit  ·  Vault Lab Uniform\n\nPLAY STYLE\nSeek irradiated zones deliberately. Rad Child regenerates HP inside them, Atomic! makes you 25% faster. Burning Sensation drains rads so you control the stack rather than capping out.\n\nWear the Radiation Suit as primary armour — Radiation Renegade gives it +10 DT and +25 AP. PHOENIX Monocyte Breeder adds passive regen on top. Cannibal feeding is free healing between fights.\n\nRP\nSomething happened at the reactor. They don\'t talk about what. Comfortable in places that would kill anyone else. Genuinely doesn\'t understand why everyone is so upset about radiation. Has developed opinions about different flavours of irradiated water.",
  },
  ...
  /* ── 21. TRIBAL TERROR ───────────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nChance\'s Knife  ·  Blood-Nap  ·  Love and Hate  ·  Pushy\n\nARMOUR\nArmor of the 87th Tribe  ·  Wanderer\'s Leather Armor  ·  Ledoux\'s Hockey Mask  ·  Rebreather\n\nPLAY STYLE\nNo technology. Crafted weapons, primitive melee, thrown spears and hatchets. Implant Y-7 from Big Mountain adds HP and AP from food — eat before every fight.\n\nContact Courier adds +50% Unarmed damage. Tribal Ways gives +8 DT in tribal outfits — never wear anything modern. Coiled Snake rewards throwing from a crouch.\n\nRP\nRejects the Old World completely. Does not use guns. Does not read terminals. Will not explain themselves in wasteland terms. Has a name in their language that outsiders cannot pronounce and a wasteland name they find insulting but answer to anyway.",
  },

  /* ── 22. CHEM-ADDICT CHEMIST ─────────────────────────────── */
  {
    id:'chemaddict', name:'The Cook', tagline:'The high never ends. Neither does the carnage.',
    ...
    perks:[
      ...
      ['Swift Learner','Bonus XP per point of INT — INT 4 ✓, PER 4 ✓'],
      ['Gunslinger','+15% accuracy with one-handed weapons — Guns 40 ✓ — rank 1'],
      ['Party Hard','Ignore all negative alcohol effects — END 6 ✓'],
      ['Old World Gourmet','+25% addiction resistance, healing bonus from junk food and pre-war liquor — END 6 ✓, Survival 45 ✓'],
      ['Fight Hungry','Hunger >150 in combat: +10% damage, +1 END — Survival 20 ✓'],
      ['Fast Metabolism','Stimpak +20% heal; alcohol clears rads twice as fast — END 5 ✓, Survival 25 ✓'],
      ['Finesse','+5 effective LCK of crit chance — AGL 5 ✓'],
      ['Friction Addiction','+1 DT, enemy crit -3% per STR while blocking; AP restored on hit — END 7 ✓'],
      ['Chemist','All chems last twice as long — Level 14 ✓, Med. 60 ✓'],
      ['Nuka Chemist','Special Nuka-Cola recipes unlocked at Workbench — Level 14 ✓, Science 65 ✓'],
      ['Better Criticals','3% crit damage per PER — PER 7 ✓ with implant, LCK 6 ✓'],
      ['Death Wish','XP bonus when enemy crits you — courts death that courts you back'],
      ['ACTION STAR [+AP REGEN]','Rapid AP recovery for relentless chem-fuelled pressure'],
      ['Implant GRX','Non-addictive subdermal Turbo injector, 5 uses/day — END 8 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    notes:"WEAPONS\nLucky  ·  Sleepytyme  ·  Maria  ·  Blackhawk\n\nARMOUR\nGrifter\'s Fit  ·  Leather Rebel  ·  Cryptochromatic Spectacles  ·  Lucky Shades\n\nPLAY STYLE\nThe chem rotation is the build. Psycho before heavy combat, Turbo in Bullet Time, Med-X as a last resort. Logan\'s Loophole means no withdrawal — ever.\n\nTwisted doubles XP and AP while active. Hot Blooded fires below 50% HP. Implant GRX rank 2 at LVL30 gives a non-addictive Turbo that Logan\'s own rule cannot block — the one exception.\n\nRP\nSelf-medicated through the apocalypse and came out ahead. Has a very specific pre-combat ritual. Does not recommend their lifestyle but is alive and several of the people who warned them are not. Carries a personal pharmacopoeia.",
  },
  ...
  /* ── 23. TERRIFYING PRESENCE ─────────────────────────────── */
  {
    ...
    perks:[
      ...
      ['Purifier','+50% dmg with Melee/Unarmed vs Centaurs, Deathclaws, Super Mutants, Feral Ghouls'],
      ...
      ['Better Criticals','+3% crit damage per PER — PER 6 ✓, LCK 8 ✓ — every heavy melee hit lands harder'],
      ['Fatal Counter','Double damage and doubled crit chance when attacking a staggered target — STR 9 ✓, PER 5 ✓, Melee 75 ✓ (tagged + invested)'],
      _EMPTY_PERK_SLOT,
    ],
    implantsTaken:{
      '"Hypertrophy Accelerator" Strength Implant': true,
    ...
    notes:"WEAPONS\nOh, Baby!  ·  Nuka-Breaker  ·  Chainsaw  ·  Ripper\n\nARMOUR\nPint-Sized Slasher Mask  ·  Grifter\'s Fit  ·  Wanderer\'s Leather Armor  ·  Ledoux\'s Hockey Mask\n\nPLAY STYLE\nApproach with weapon holstered — Non-Combatant gives +8 DT and +15% DR. Exhaust every dialogue option before drawing. When you do draw it, Butcher procs AP on every cripple.\n\nChainsaw Carnage at LVL26 grants +10 DT on every kill and a brief time-slow. Better Criticals at LVL28 sharpens every heavy hit. Fatal Counter at LVL30 doubles damage against staggered targets — the combo chain closes itself.\n\nRP\nSoft-spoken. Extremely polite. Has never needed to raise their voice because the reputation precedes them into every room. The Chainsaw is a last resort. They say this entirely without irony.",
  },
  ...
  /* ── 26. GLASS CANNON ────────────────────────────────────── */
  {
    ...
    startingTraits:[{name:'Doom Spiral'},{name:'Fickle'},{name:'Built to Destroy'},{name:'Hot Blooded'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ...
      ['Ninja','+15% melee/unarmed crit chance; sneak crits +25% dmg — Sneak 80 ✓, Unarmed 80 ✓'],
      ...
      ['Fatal Counter','2× damage and crit when target staggered by a block — STR 5 ✓, Unarmed 75 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    notes:"WEAPONS\nLucky  ·  Ratslayer  ·  Love and Hate  ·  Pushy\n\nARMOUR\nGrifter\'s Fit  ·  Leather Rebel  ·  Lucky Shades  ·  Pint-Sized Slasher Mask\n\nPLAY STYLE\nDoom Spiral is always active — your death chance rises with damage taken, so the goal is ending every fight before it ends you. Maximum AP above everything: the longer Bullet Time runs, the more crits you stack.\n\nWinning Streak doubles crit chance after every crit — once the chain starts it should not stop. Never holster. Never negotiate. Never take a hit you can avoid.\n\nRP\nVery evil. Very confident. Certain the cosmos has specifically arranged for them to survive everything they\'ve survived so far. Wrong in a way that hasn\'t been proven yet. Extravagant about everything.",
  },
  ...
  /* ── 28. THE SCOUNDREL ───────────────────────────────────── */
  {
    ...
    perks:[
      ...
      ['Friend of the Night','Eyes adapt to low-light conditions — PER 7 ✓, Sneak 40 ✓'],
      ['Light Step','Mine/trap trigger chance -10% per AGL — AGL 8 = -80% — Sneak 40 ✓'],
      ['Wasteland Masquerade','+1 CHA and INT, +15% XP outside combat while wearing headwear — PER 4 ✓, CHR 6 ✓, Speech 35 ✓'],
      ...
      ['Voyeur','Looking at unaware target builds crit damage up to +25% — PER 7 ✓, Sneak 50 ✓'],
    ...
    notes:"WEAPONS\nSleepytyme  ·  Lucky  ·  Wild Bill\'s Sidearm  ·  Li\'l Devil\n\nARMOUR\nAssassin Suit  ·  Cryptochromatic Spectacles  ·  Lucky Shades  ·  Boone\'s Beret\n\nPLAY STYLE\nNever be seen. Mister Sandman kills sleeping targets silently — learn patrol routes and check rest points before engaging.\n\nThree Thief ranks push pickpocket high enough to lift weapons off enemies before they know you\'re there. Implant M-5 adds 10% crouch speed so this character covers ground faster crouched than most do standing. Small Frame\'s +15 Sneak at creation means you start better at this than any other build.\n\nRP\nEverything is an opportunity. Every locked door is an invitation. Every pocket is a question. Has a personal rule about only stealing from people who can afford it — applies this rule very loosely.",
  },
  ...
  /* ── 39. THE POLITICIAN ──────────────────────────────────── */
  {
    ...
    notes:"WEAPONS\nLucky  ·  Maria  ·  Zhu-Rong V418  ·  Sleepytyme\n\nARMOUR\nBenny\'s Suit  ·  Ambassador Crocker\'s Suit  ·  Suave Gambler Hat  ·  Lucky Shades\n\nPLAY STYLE\nThree Scoundrel ranks hit maximum vendor discount by LVL14. Wolf in Sheep\'s Clothing adds +2 CHR and +5 crit when wearing enemy faction armour — dress like whoever you\'re dealing with.\n\nClothes Make The Courier adds +7 to Barter, Speech and Sneak while wearing outfits over armour. Collective Consciousness at LVL24 turns every allied faction into a passive Speech bonus.\n\nRP\nHas a position on every issue that is whatever the person they\'re talking to needs to hear. Does not consider this dishonest — considers it efficient. Has genuine loyalties that are entirely personal rather than ideological. Would die for exactly two people and is not going to say who.",
  },
  ...
  /* ── 41. THE GRENADIER ───────────────────────────────────── */
  {
    ...
    perks:[
      ...
      ['Piercing Strike','Negate 2 DT per STR with melee — STR 7 = 14 DT ignored'],
      ['Unstoppable Force','4x damage through blocks — STR 7 ✓, Melee 60 ✓'],
      ['Tenacious','Crippled limbs all grant movement/spread/BT improvements — END 7 ✓, LCK 3 ✓, Survival 50 ✓'],
    ...
    notes:"WEAPONS\nFrag Grenades  ·  Incendiary Grenades  ·  Plasma Grenades  ·  Bumper Sword\n\nARMOUR\nExplorer\'s Gear  ·  Composite Recon Armor  ·  Rebreather  ·  Ledoux\'s Hockey Mask\n\nPLAY STYLE\nGo prone before throwing — Coiled Snake adds +15% velocity and attack speed while crouched. Loose Cannon fires faster with more scatter, so close the distance before throwing. Keep multiple grenade types stocked at all times.\n\nImplant C-13 rewards enemies launched into the air by blasts. The melee fallback is for when grenades run out, which shouldn\'t happen.\n\nRP\nHas strong geometric opinions about every space they enter. Involuntarily calculates blast radii in social situations. Is never more than ten metres from a grenade. Finds silence concerning.",
  },
  ...
  /* ── 42. THE SOLAR PRIEST ────────────────────────────────── */
  {
    ...
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Walker Instinct','+1 PER and AGL while outside and crouched — Survival 35 ✓ (tagged), PER 3 ✓'],
      ['ACTION STAR [+TOTAL AP]','Expanded AP reserves for sustained Bullet Time fire — AGL 5 ✓'],
      ['Return To Ashes','+50% damage when both you and your enemy are using fire weapons — END 7 ✓, Ener. Weap. 50 ✓'],
      ['Radiation Renegade','Wearing rad suit: +10 DT/+20% DR, +25 AP, -20% limb damage, no sprint detection penalty — Science 50 ✓'],
      ['Anodized Armor','Metal armor + 10+ scrap electronics: -35% item condition loss, +8% DR — Science 40 ✓'],
      ['Fight Hungry','Advanced starvation: +10% damage, +1 END in combat — Survival 20 ✓'],
      ['Burning Wasteland Sun','+8% crit chance and +15% crit damage with fire weapons; bonus limb and fatigue damage — END 6 ✓, Ener. Weap. 50 ✓'],
      ['Survivalist','Sating hunger, thirst, and sleep twice as effective — END 6 ✓, Survival 75 ✓'],
      ['Vigilant Recycler','More likely to recover drained ammo; efficient recycling recipes — Science 70 ✓, Ener. Weap. 50 ✓'],
      ['Laser Commander','+15% damage and +10% crit chance with laser weapons — Ener. Weap. 75 ✓'],
      ['Run n\' Gun','Spread penalties while moving reduced by 50% — Guns 45 or Ener. Weap. 45 ✓'],
      ['Better Criticals','+3% crit damage per PER — PER 8 base = +24% — PER 6 ✓, LCK 6 ✓'],
      ['Concentrated Fire','BT accuracy compounds each shot on same body part — Ener. Weap. 60 ✓'],
      ['Sniper','+25% head BT hit chance; +25% crit chance scoped and crouched — PER 8 ✓, Ener. Weap. 75 ✓'],
      ['Meltdown','+25% crit damage with plasma; criticals on metal armor targets shred their resistances — Ener. Weap. 90 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    notes:"WEAPONS\nAER14 Prototype  ·  Euclid\'s C-Finder  ·  YCS/186  ·  Multiplas Rifle\n\nARMOUR\nNCR Ranger Combat Armor  ·  Rebreather  ·  Explorer\'s Gear  ·  1st Recon Beret\n\nPLAY STYLE\nBurning Wasteland Sun requires being outdoors between 5AM and 7PM — plan rest cycles around the solar window. Solar Powered adds +1 STR, AGL and END during daylight.\n\nIdeologue at Good karma pays passively. PHOENIX Monocyte Breeder regenerates HP while in the sun. The build peaks at midday — schedule major fights accordingly.\n\nRP\nDeveloped a theological relationship with solar energy somewhere between the bombs and now. Does not push it on others. Has morning rituals facing east. Very calm about everything, including violence. The serenity is genuine.",
  },

  /* ── 43. THE VAULT DWELLER ───────────────────────────────── */
  {
    id:'vaultdweller', name:'The Vault Dweller', tagline:'Optimistic, over-prepared, and completely out of her depth.',
    notes:"WEAPONS\n10mm Pistol  ·  Ratslayer  ·  Hunting Rifle  ·  Plasma Defender\n\nARMOUR\nVault 111 Jumpsuit  ·  Vault 101 Jumpsuit  ·  Vault 21 Jumpsuit  ·  Lucky Shades\n\nPLAY STYLE\nAttempt every speech check before opening fire — this build passes more than you\'d expect. Ferocious Loyalty makes companions nearly unkillable when things go wrong, which they will.\n\nLife Giver and Rapid Reload keep you and your companions functional in a fight. The vault suit is not optional — it\'s the armour. Clothes Make The Courier rewards the commitment. Lawbringer turns every villain into income.\n\nRP\nRaised to believe the world is manageable with the right attitude and sufficient preparation. The world has been doing its best to prove otherwise. She\'s not listening. Keeps a stimpak count. Still says please and thank you. Will absolutely shoot you if she has to, and will feel terrible about it.",
    icon:'🔵', color:'#5B8DD9', origin:'CW', mode:'std', buildKarma:'good', difficulty:2,
    special:{STR:5,PER:7,END:6,CHA:8,INT:7,AGI:6,LCK:7},
    tags:[false,false,false,false,true,false,true,false,false,false,false,true,false,false],
    startingTraits:[{name:'Good Natured'},{name:'Educated'},{name:'Empath'},{name:'Ideologue'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Swift Learner','+2% XP per INT — INT 7 + Educated trait = exceptional XP gains — INT 4 ✓, PER 4 ✓'],
      ['Daddy\'s Boy/Girl','Hacking easier; chem efficiency +10% — the Vault trained her well — INT 6 ✓, rank 1'],
      ['Ferocious Loyalty','Companions gain massive DR when you drop below 50% health — CHR 8 ✓. Protect your people.'],
      ['Scoundrel','Vendor discount +8%; XP for speech checks — CHR 7 ✓ — rank 1'],
      ['Non-Combatant','+8 DT, +15% DR while weapon holstered — she keeps reminding herself she is not a soldier'],
      ['Life Giver','+30 HP to you and companions; Doctor Bag doubled on companions — keeping everyone alive is the mission'],
      ['Rapid Reload','All weapon reloads 15% faster — AGL 5 ✓, Guns 40 ✓. She reloads faster than you expect.'],
      ['Scoundrel','Discount stacks; speech XP — CHR 7 ✓ — rank 2'],
      ['Magnetic Personality','One extra companion slot — CHR 8 base, under 10 ✓. She collects people.'],
      ['Lawbringer','Evil characters drop a finger for caps and good karma — Good Karma ✓. Justice pays.'],
      ['Chemist','All chems last twice as long — Medicine 60 ✓. Efficient with her supplies.'],
      ['Clothes Make The Courier','+10% XP, +7 Barter/Speech/Sneak while wearing clothing — INT 7 ✓. The vault suit earns its keep.'],
      ['Living Anatomy','See Health and DT of any target; +5% damage vs humans and ghouls — Medicine 70 ✓'],
      ['Scoundrel','Maximum vendor discount — CHR 7 ✓ — rank 3'],
      ['Better Criticals','+3% crit damage per PER — PER 8 via implant = +24% — for when diplomacy fails — PER 6 ✓, LCK 6 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    uniArmor:[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    charLevel:30,
    skillPoints:{"BARTER":0,"BIG GUNS":0,"ENERGY WEAPONS":0,"EXPLOSIVES":0,"GUNS":82,"LOCKPICK":70,"MEDICINE":82,"MELEE WEAPONS":0,"REPAIR":70,"SCIENCE":70,"SNEAK":0,"SPEECH":82,"SURVIVAL":0,"UNARMED":0},
    levelUpBonuses:["cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp"],
    skillHistory:[
      {level:2,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:3,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:4,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:5,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:6,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:7,allocation:{"MEDICINE":14},gains:{"MEDICINE":28},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:8,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:9,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:10,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:11,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:12,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:13,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:14,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:15,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:16,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:17,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:18,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:19,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:20,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:21,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:22,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:23,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:24,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:25,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:26,allocation:{"MEDICINE":14},gains:{"MEDICINE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:27,allocation:{"MEDICINE":14},gains:{"MEDICINE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:28,allocation:{"MEDICINE":14},gains:{"MEDICINE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:29,allocation:{"MEDICINE":14},gains:{"MEDICINE":14},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14},
      {level:30,allocation:{},gains:{},tagged:["GUNS","MEDICINE","SPEECH"],pointsTotal:14}
    ],
    description:"GUNS, MEDICINE, and SPEECH all tagged — she came prepared for everything except how bad it would actually be. MEDICINE investment reflects rigorous Vault training; SPEECH reflects someone who genuinely believes problems can be talked through. GUNS because she\'s not naive.",
  },

  /* ── 44. THE MADE MAN ────────────────────────────────────── */
  {
    id:'mademan', name:'The Made Man', tagline:'Everyone respects a man in a nice suit with a big gun.',
    notes:"WEAPONS\n.45 Auto Pistol  ·  12.7mm Submachine Gun  ·  Sawn-Off Shotgun  ·  Maria  ·  Lucky\n\nARMOUR\nBenny\'s Suit  ·  Tenpenny\'s Suit  ·  Black Beret  ·  Lucky Shades  ·  Suave Gambler Hat\n\nPLAY STYLE\nSpeech checks first, always. Gallows Humor fires after every kill so lean into combat as a performance. Scoundrel and Collective Consciousness reward faction relationships, but this build builds reputation through fear, not goodwill.\n\nTag! at LVL16 unlocks BIG GUNS — the sawn-off comes out when the conversation is over. Notorious E.V.I.L. doubles Miss Fortune and Mysterious Stranger appearances, making high-stakes fights feel like a hit going exactly to plan. Keep a suit on at all times.\n\nRP\nJoined the organisation young. Worked up through patience and a talent for knowing exactly what people are afraid of. Never raises his voice. Gives compliments that feel like threats. Has very strong opinions about loyalty, most of which end badly for someone else.",
    icon:'🎩', color:'#2C3E50', origin:'MW', mode:'std', buildKarma:'evil', difficulty:3,
    special:{STR:5,PER:7,END:5,CHA:9,INT:7,AGI:7,LCK:7},
    tags:[true,false,false,false,true,false,false,false,false,false,false,true,false,false],
    startingTraits:[{name:'Magnate'},{name:'Built to Destroy'},{name:'Terrifying Presence'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Gallows Humor','+10 Speech and Barter for 30s after a kill; +1 CHR with evil companion — PER 5 ✓, CHR 5 ✓, Evil Karma ✓. Set the tone early.'],
      ['Scoundrel','Vendor discount +8%; XP for speech checks — CHR 7 ✓ — rank 1. The smile that costs nothing.'],
      ['Gunslinger','+15% accuracy with one-handed weapons — rank 1 — Guns 40 ✓. Handle a pistol like an extension of the handshake.'],
      ['Quick Draw','Draw and holster speed scales with weapon skill — AGL 5 ✓. A good businessman never lets the other man draw first.'],
      ['The Professional ','+20% sneak attack crit damage with pistols and SMGs — Sneak 50 ✓'],
      ['Scoundrel','Discount stacks — CHR 7 ✓ — rank 2'],
      ['Devil\'s Advocate','+25 Speech while Karma is Very Evil — CHR 8 ✓, Evil Karma ✓. The organisation rewards commitment.'],
      ['Tag!','Fourth tag skill — BIG GUNS now tagged. The sawn-off comes out of the case.'],
      ['Wolf In Sheep\'s Clothing','Wearing enemy faction armour: +2 CHR, +10 Sneak, +5% crit — Speech 40 ✓'],
      ['Clothes Make The Courier','+10% XP, +7 Barter/Speech/Sneak while wearing clothing — INT 7 ✓. The suit does half the work.'],
      ['Scoundrel','Maximum vendor discount — CHR 7 ✓ — rank 3'],
      ['Collective Consciousness','+2 Speech per liked faction; -2% Barter per faction if Evil — CHR 6 ✓. A network is leverage.'],
      ['Handgun Hotshot','+5 DT penetration; +15% attack speed with ballistic handguns — Guns 40 ✓. The .45 does the convincing.'],
      ['Slick Shooter','+50% crit chance while the target is reloading — INT 7 ✓. Patience is a weapon.'],
      ['Grim Reaper\'s Sprint','Kill in Bullet Time restores 20 AP — LCK 6 ✓. Clean, efficient, professional.'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    uniArmor:[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    charLevel:30,
    skillPoints:{"BARTER":82,"BIG GUNS":28,"ENERGY WEAPONS":0,"EXPLOSIVES":0,"GUNS":82,"LOCKPICK":60,"MEDICINE":0,"MELEE WEAPONS":0,"REPAIR":0,"SCIENCE":60,"SNEAK":60,"SPEECH":82,"SURVIVAL":0,"UNARMED":0},
    levelUpBonuses:["ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","ap","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw","cw"],
    skillHistory:[
      {level:2,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:3,allocation:{"GUNS":7,"BARTER":7},gains:{"GUNS":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:4,allocation:{"SPEECH":7,"BARTER":7},gains:{"SPEECH":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:5,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:6,allocation:{"GUNS":7,"BARTER":7},gains:{"GUNS":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:7,allocation:{"SPEECH":7,"BARTER":7},gains:{"SPEECH":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:8,allocation:{"SNEAK":14},gains:{"SNEAK":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:9,allocation:{"SNEAK":14},gains:{"SNEAK":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:10,allocation:{"SNEAK":14},gains:{"SNEAK":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:11,allocation:{"SNEAK":14},gains:{"SNEAK":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:12,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:13,allocation:{"GUNS":7,"BARTER":7},gains:{"GUNS":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:14,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:15,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","SPEECH","BARTER"],pointsTotal:14},
      {level:16,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":28},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:17,allocation:{"BIG GUNS":14},gains:{"BIG GUNS":28},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:18,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:19,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:20,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:21,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:22,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:23,allocation:{"SCIENCE":14},gains:{"SCIENCE":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:24,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:25,allocation:{"GUNS":7,"BARTER":7},gains:{"GUNS":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:26,allocation:{"SPEECH":7,"BARTER":7},gains:{"SPEECH":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:27,allocation:{"GUNS":7,"SPEECH":7},gains:{"GUNS":14,"SPEECH":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:28,allocation:{"GUNS":7,"BARTER":7},gains:{"GUNS":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:29,allocation:{"SPEECH":7,"BARTER":7},gains:{"SPEECH":14,"BARTER":14},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14},
      {level:30,allocation:{},gains:{},tagged:["GUNS","SPEECH","BARTER","BIG GUNS"],pointsTotal:14}
    ],
    description:"GUNS, SPEECH, and BARTER all tagged from the start — the full social and combat toolkit of organised crime. BIG GUNS added via Tag! at LVL16 when the sawn-off becomes available. SNEAK invested without tagging for The Professional and stealth approach options. LOCKPICK and SCIENCE as secondary investments for access and self-sufficiency.",
  },

  /* ── 45. THE PENITENT ────────────────────────────────────── */
  {
    id:'penitent', name:'The Penitent', tagline:'I have done terrible things in service of what I believed was right.',
    notes:"WEAPONS\nThe Colt (Revolver)  ·  Brush Gun  ·  Bowie Knife  ·  Combat Knife\n\nARMOUR\nWasteland Wanderer Outfit  ·  Courier Duster  ·  Prewar Businesswear  ·  Lucky Shades\n\nPLAY STYLE\nApproach with weapon holstered — Non-Combatant gives +8 DT and +15% DR while walking toward something that should kill you. Stonewall means you do not go down. Purifier exists because some things simply need to be destroyed.\n\nImplant GRX is the build\'s signature: activate it in combat and move at a speed that should not be possible for something wearing a coat. The revolver is The Colt — carry it like it means something. The blade is for the things that deserve it personally.\n\nRP\nAncient. Patient. Makes decisions carefully and lives with the consequences in ways that suggest the weight is considerable. Doesn\'t understand humour but tries. Takes the concept of protecting people with a seriousness that borders on alarming. Has a coat that should not still be in one piece.",
    icon:'🪶', color:'#8E44AD', origin:'MW', mode:'std', buildKarma:'good', difficulty:3,
    special:{STR:8,PER:7,END:8,CHA:4,INT:7,AGI:5,LCK:7},
    tags:[false,false,false,false,true,false,true,true,false,false,false,false,false,false],
    startingTraits:[{name:'Trigger Discipline'},{name:'Bloody Mess'},{name:'Ideologue'},{name:'War Child'}],
    traits:['','','','','','','','','','','',''],
    perks:[
      ['Non-Combatant','+8 DT, +15% DR while weapon holstered in combat — the coat, moving calmly through the wasteland toward something that should kill it'],
      ['Nowhere To Hide','Double damage to fleeing targets, +50% to cloaked — PER 6 ✓. Nobody gets away from what is coming for them.'],
      ['Blunt Force Trauma','+10% crit chance and attack speed with blunt weapons — STR 8 ✓, Melee 35 ✓ — rank 1'],
      ['Stonewall','+1 DT per END vs melee and unarmed; immune to knockdown — END 8 ✓, STR 8 ✓. It does not fall.'],
      ['Toughness','+1 DT per END — END 8 = +8 DT permanently — END 5 ✓'],
      ['Cowboy','+15% attack speed, accuracy, and damage with cowboy weapons — Guns 45 ✓, Melee 25 ✓. The Colt is a cowboy weapon.'],
      ['Purifier','+50% damage with melee and unarmed against Centaurs, Nightstalkers, Deathclaws, Super Mutants, Feral Ghouls — LVL 14 ✓. Some things need putting down.'],
      ['Life Giver','+30 HP to you and companions; Doctor Bag doubled on companions — giving life is the mission'],
      ['Piercing Strike','Melee and unarmed negate 2 DT per STR — STR 9 via implant = 18 DT ignored — STR 7 ✓, Melee 50 ✓'],
      ['Threat Range','+10% attack speed and damage with heavy melee; +15% DR while attacking — STR 7 ✓, Melee 40 ✓'],
      ['Unstoppable Force','4x damage through enemy blocks while moving forward — STR 7 ✓, Melee 60 ✓. The wall breaks.'],
      ['Living Anatomy','See Health and DT of any target; +5% damage vs humans and ghouls — Medicine 70 ✓'],
      ['Rad Absorption','Radiation dissipates 1 point every 10 seconds — END 8 ✓. Ancient things shed damage slowly.'],
      ['Better Criticals','+3% crit damage per PER — PER 8 via implant = +24% — PER 6 ✓, LCK 6 ✓'],
      ['Implant GRX','Non-addictive subdermal Turbo injector — 2 seconds, 5 uses/day — END 8 ✓. The coat becomes a blur. This is as close to teleportation as the wasteland allows.'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
    ...
    uniArmor:[false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
    charLevel:30,
    skillPoints:{"BARTER":0,"BIG GUNS":0,"ENERGY WEAPONS":0,"EXPLOSIVES":0,"GUNS":82,"LOCKPICK":60,"MEDICINE":82,"MELEE WEAPONS":82,"REPAIR":60,"SCIENCE":0,"SNEAK":0,"SPEECH":60,"SURVIVAL":0,"UNARMED":0},
    levelUpBonuses:["hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","hp","ap","ap","ap","ap","ap","ap","ap","ap","ap"],
    skillHistory:[
      {level:2,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:3,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:4,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:5,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:6,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:7,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:8,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:9,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:10,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:11,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:12,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:13,allocation:{"LOCKPICK":14},gains:{"LOCKPICK":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:14,allocation:{"SPEECH":14},gains:{"SPEECH":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:15,allocation:{"SPEECH":14},gains:{"SPEECH":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:16,allocation:{"SPEECH":14},gains:{"SPEECH":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:17,allocation:{"SPEECH":14},gains:{"SPEECH":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:18,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:19,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:20,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:21,allocation:{"REPAIR":14},gains:{"REPAIR":14},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:22,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:23,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:24,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:25,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:26,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:27,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:28,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:29,allocation:{"GUNS":5,"MELEE WEAPONS":5,"MEDICINE":4},gains:{"GUNS":10,"MELEE WEAPONS":10,"MEDICINE":8},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14},
      {level:30,allocation:{},gains:{},tagged:["GUNS","MELEE WEAPONS","MEDICINE"],pointsTotal:14}
    ],
    description:"GUNS, MELEE WEAPONS, and MEDICINE all tagged — The Colt, the blade, and the ability to keep people alive. High END and STR make this something that weathers punishment without complaint. Implant GRX at LVL24 and 26 is the build\'s signature: in combat, it moves at a speed that has no business existing in a body that size.",
  },
