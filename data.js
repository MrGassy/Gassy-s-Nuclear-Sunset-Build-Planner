...
const SKILL_GOVERNING = {
    'BARTER':'CHR','BIG GUNS':'END','ENERGY WEAPONS':'PER','EXPLOSIVES':'PER',
    'GUNS':'AGI','LOCKPICK':'PER','MEDICINE':'INT','MELEE WEAPONS':'STR',
    'REPAIR':'INT','SCIENCE':'INT','SNEAK':'AGI','SPEECH':'CHR','SURVIVAL':'END','UNARMED':'END'
};
        ...
        extra: (val) => {
            ...
            return `<div class="sinfo-companion-box">
                ...
                <div class="sinfo-companion-thresholds">
                    ...
                    <div class="${val>=4?'sinfo-thresh-met':'sinfo-thresh'}">CHR 4 → 1 companion</div>
                    <div class="${val>=7?'sinfo-thresh-met':'sinfo-thresh'}">CHR 7 → 2 companions</div>
                    <div class="${val>=10?'sinfo-thresh-met':'sinfo-thresh'}">CHR 10 → 3 companions</div>
...
const BOBBLEHEADS_DATA = {
    special: [
        ...
        { name: 'CHR', loc: 'Vault 108, Cloning Lab' },
