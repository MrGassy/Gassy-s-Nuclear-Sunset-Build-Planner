...
const COMPANIONS_DATA = [
  { name:'ED-E', origin:'MW', icon:'📡', desc:"ED-E cannot bear any of your burdens. He has 5x crit. chance, but he suffers -75% crit. damage." },
  { name:'Boone', origin:'MW', icon:'🎯', desc:"Boone takes the time to line up his shots, but when he fires, he hits his target. He has -50% spread with non-automatic weapons, but has -50% attack speed. He also suffers -25% damage with Unarmed weapons, but gains +25% damage when using combat and bowie knives." },
  { name:'Cass', origin:'MW', icon:'🥃', desc:"Cass shoots first and asks questions never. She gains +25% attack speed with non-automatic weapons and +25% reload speed, as well as +15% run speed in light armors. She will periodically steal and drink your Whiskey if you are carrying any, which will double her attack and reload speed boosts when she drinks it." },
  { name:'Arcade', origin:'MW', icon:'⚡', desc:"Arcade specializes in Energy Weapons. He gains 50% better crit. damage and spread when using Energy Weapons and has no movement spread penalty when using medium armors, but he suffers -50% damage with Melee and Unarmed weapons." },
  { name:'Lily', origin:'MW', icon:'👵', desc:"Lily's vision may have suffered, but she's still pretty tough. She has -75% reload speed, -25% run speed, and no crit. chance whatsoever, but she takes 25% less damage from all sources." },
  { name:'Raul', origin:'MW', icon:'🤠', desc:"Raul may be old, but his skills are still sharp. He gains +75% attack speed with western weapons, and his equip speed and limb damage are improved by 50%, but he suffers -50% carry weight, and -20% sneak speed." },
  { name:'Veronica', origin:'MW', icon:'✊', desc:"Veronica knows her greatest tools; her fists - she will only use Unarmed weapons. She has +10% run speed and gains +25% crit. damage while not wearing headgear that covers her face, but she suffers -35% damage when using a Melee Weapon instead of an Unarmed weapon. She also gains +25% crit. chance when there is another woman in your party." },
  { name:'Rex', origin:'MW', icon:'🐕', desc:"Rex can't carry much and his sensors are tuned to detect animals and vermin very effectively, but he is highly resistant to many forms of damage. He will always deal critical hits against animals and insects, and takes -50% limb damage, but will always receive critical hits from Abominations, Super Mutants, and Robots." },
  { name:'Follows-Chalk', origin:'MW', icon:'🏹', desc:"Follows-Chalk was trained by Joshua Graham; as such, he takes time to aim his shots accurately. He has -75% spread and +20% crit. chance when using .45 Auto Pistols, but -66% attack speed. He also suffers -25% damage with melee weapons, and has 4x Energy Weapon spread." },
  { name:'Waking Cloud', origin:'MW', icon:'🐾', desc:"Waking Cloud has honed her skills sharply, and will not vary from what she knows. She will not wear any clothing but her own, and she will not use any weapon except her Yao-Guai Gauntlet. She takes -75% limb damage, and enemies have -75% crit. chance against her. She deals 2x crit. damage against Yao Guai, and has 2x crit. chance while below 25% health." },
  { name:'Clover', origin:'CW', icon:'🗡', desc:"Clover is most capable with shotguns and one-handed melee weapons. She gains +10 DT and +15 DR when wearing light armor or clothing, and +25% crit. chance when using shotguns and one handed melee weapons, but suffers -70% equip and reload speed when using heavy weapons." },
  { name:'Dogmeat', origin:'CW', icon:'🐺', desc:"Dogmeat is an outstanding example of tenacity in the wasteland. He has +50 Sneak and +15% run speed and gains +4 Strength, +4 Endurance, and +25% Damage Resistance while below 25% health, but he has -90% carry weight." },
  { name:'Fawkes', origin:'CW', icon:'👹', desc:"Fawkes' time spent imprisoned has diminished his skill with ranged weapons. He suffers 3x weapon spread and -15% run speed, but deals 2x crit. damage and receives -80% limb damage." },
  { name:'Charon', origin:'CW', icon:'💀', desc:"Charon's years have taken their toll on him. He has -50% spread when using explosives and automatic weapons, but he suffers -75 max health, -25% attack speed with non-automatic weapons, and he takes 2x limb damage." },
  { name:'Jericho', origin:'CW', icon:'🍺', desc:"You already paid Jericho; what does he care if you catch a stray bullet? He has x2 spread with automatic weapons, and he deals 3x damage to you if he hits you. He gains +10 DT when using medium armors, and has +5 DT penetration." },
  { name:'Butch', origin:'CW', icon:'🐍', desc:"Butch is fresh out of the vault, and he needs your guidance to survive in the wasteland. He suffers 25% worse spread and limb damage until he spends a month with you, at which point those maluses will disappear and he will gain +25% attack speed.\nButch will observe the karmic actions you perform, and after a month his disposition will change for the better (-75% enemy crit. chance) or worse (+50% crit. damage)" },
  { name:'Star Paladin Cross', origin:'CW', icon:'🛡', desc:"Star Paladin Cross is very competent, but she undervalues your input on her behaviour. She will always stay close to you, regardless of the follow distance you instruct of her. She has -25% attack speed with non-Melee and non-Energy weapons, and she will only wear her own armor." },
  { name:'Sergeant RL-3', origin:'CW', icon:'🤖', desc:"Sergeant RL-3's scavenged sensors may be a bit... imprecise. He suffers +50% spread and -90% crit. chance." },
];
 ...
 * MW data covers the base game plus Dead Money, Old World Blues & Lonesome Road
 * copies (per the Fallout Wiki "Fallout: New Vegas skill books" page).
 */
...
const SKILL_BOOKS_MW = [
  { skill:'BARTER', name:'Tales of a Junktown Jerky Vendor', count:6, copies:[
    { location:'Allied Technologies Offices',        detail:'West side, largest room. On the floor in front of the Nuka-Cola machine.' },
    { location:'Cap Counterfeiting Shack',           detail:'Small back cellar room. On the suitcase by the bed.' },
    { location:'Marked Men Guard Outpost',           detail:'LONESOME ROAD. Via the cellar door on the eastern wall. On a table near gore on the northwest wall.' },
    { location:'Primm (Bison Steve)',                 detail:'Gift shop. On the floor behind the counter.' },
    { location:'Salida del Sol South',                detail:'DEAD MONEY. In a building opposite the Salida del Sol house. On a bookshelf.' },
    { location:'Vault 22',                            detail:'Lab room up the stairs from pest control. On the table with the bubbling vials.' },
  ]},
  { skill:'ENERGY WEAPONS', name:'Nikola Tesla and You', count:6, copies:[
    { location:'Hidden Valley',                       detail:"First floor of the bunker building. In a white plastic bin by the desk in Schuler's office." },
    { location:'Hopeville Missile Base HQ',           detail:'LONESOME ROAD. First room, wooden shelf directly on the right upon entering, hidden under a burned book.' },
    { location:'Old Nuclear Test Site',               detail:'Inside the nuclear test shack. On the small table opposite the exit.' },
    { location:'REPCONN Headquarters',                detail:'First floor, past the Very Hard locked door. On top of a safe (key is on the third floor).' },
    { location:'REPCONN Headquarters',                detail:'Second floor, through the first door on the left. On the desk with the very easy locked terminal.' },
    { location:'Sierra Madre Vault',                  detail:'DEAD MONEY. In the pipes below the vault. In a duffel bag.' },
  ]},
  { skill:'EXPLOSIVES', name:'Duck and Cover!', count:6, copies:[
    { location:'Collapsed Overpass Tunnel',           detail:'LONESOME ROAD. South of the exit to The High Road, behind sandbags. In a crate underneath a teddy bear.' },
    { location:'Mojave Outpost',                      detail:'Inside the barracks. Below the bar counter, middle of the bottom shelf.' },
    { location:'Nellis Air Force Base',               detail:"Pearl's barracks. On the shelf above the grenade rifle, among the books." },
    { location:'Ranger Station Foxtrot',              detail:'On the table next to Comm Officer Lenk.' },
    { location:'Residential District',                detail:'DEAD MONEY. Under the bed in the room where Dean Domino is first encountered (requires explosives).' },
    { location:'Sloan',                               detail:'Worker barracks. On the back left shelf, under a first aid box.' },
  ]},
  { skill:'GUNS', name:'Guns and Bullets', count:6, copies:[
    { location:'Gomorrah',                            detail:"Big Sal's office, past a Hard locked door. First low bookshelf on the left." },
    { location:'Hopeville Armory',                    detail:'LONESOME ROAD. Underneath the desk in the northeast corner.' },
    { location:'Nevada Highway Patrol Station',       detail:'Entrance office. On the desk nearest the door to the cells.' },
    { location:'Raul\'s Shack',                       detail:'In the wooden crate next to the door.' },
    { location:'Sierra Madre Casino',                 detail:'DEAD MONEY. On the floor behind the cashier\'s desk, reachable via the ceiling beams.' },
    { location:'Vault 34',                            detail:'Armory common room. On the small metal table between the sofas by the pool table.' },
  ]},
  { skill:'LOCKPICK', name:'Tumblers Today', count:6, copies:[
    { location:'Bitter Springs Recreation Area',      detail:'Office shack to the west. On the desk in the smaller of the two rooms.' },
    { location:'Hopeville Missile Base',              detail:'LONESOME ROAD. Men\'s barracks toilets. Under an overturned box.' },
    { location:'The Prospector\'s Den',               detail:'Subterranean den, large barracks room. On the floor in the far right corner.' },
    { location:'Sierra Madre Casino',                 detail:'DEAD MONEY. Casino floor, southeast third-floor office. On top of the tool cabinet.' },
    { location:'Silver Peak Mine',                    detail:'In the shack, behind the two small tables. On the ground in an open locker to the right of the entrance.' },
    { location:'Wolfhorn Ranch',                      detail:'Farmhouse. Partially under the fridge without a door.' },
  ]},
  { skill:'MEDICINE', name:'D.C. Journal of Internal Medicine', count:6, copies:[
    { location:'Cave of the Abaddon',                 detail:'LONESOME ROAD. South corner, under a nightstand in the room with the bed and the exit to The Divide, beneath a RALPHIE poster.' },
    { location:'Followers Safehouse',                 detail:'Second room. On the bedside table shelf by the bed on the right (entry requires a key).' },
    { location:'HELIOS One',                          detail:'Upstairs in the main building. On a bed in the room with the east terminal password.' },
    { location:'Hell\'s Motel',                       detail:'Shack in the Mesquite Mountains crater. On the table with the radio and repair kit, below the globe with a hat.' },
    { location:'Novac',                               detail:"Ranger Andy's bungalow. In the middle of the queen-sized bed." },
    { location:'Villa Clinic',                        detail:'DEAD MONEY. Basement. In a tool cabinet next to some fire extinguishers.' },
  ]},
  { skill:'MELEE WEAPONS', name:'Grognak the Barbarian', count:6, copies:[
    { location:'Cannibal Johnson\'s Cave',            detail:'On the mattress near the radio, close to the campfire.' },
    { location:'Cottonwood Cove',                     detail:"Aurelius of Phoenix's office, upper floor of the HQ. Inside the nightstand next to the bed." },
    { location:'Hidden Supply Cave',                  detail:'Resting on one of the large metal crates, sometimes behind them (cave is behind an Average locked door).' },
    { location:'Hopeville Women\'s Barracks',         detail:'LONESOME ROAD. Back of the barracks. On a small table under a ruined book.' },
    { location:'Jacobstown',                          detail:'Lying in front of the oven in the southernmost bungalow.' },
    { location:'Villa Police Station',                detail:'DEAD MONEY. Basement, room in the northwest corner. On the floor in front of the filing cabinets.' },
  ]},
  { skill:'REPAIR', name:"Dean's Electronics", count:6, copies:[
    { location:'Abandoned BoS Bunker',                detail:'DEAD MONEY. On the metal sill opposite the reloading bench.' },
    { location:'Hopeville Missile Silo Bunker',       detail:'LONESOME ROAD. In the room with the first missile. To the left of the stairs, amongst rubble.' },
    { location:'Nellis Air Force Base',               detail:"Loyal's house. On the long counter next to the ruined terminal." },
    { location:'Puesta del Sol Switching Station',    detail:'DEAD MONEY. South-center of the map, upper level, next to the terminal that shuts off the protected speakers.' },
    { location:'Sloan',                               detail:'Worker barracks. On the top shelf to the left of the entrance.' },
    { location:'Southern Nevada Wind Farm',           detail:'In the shack. On the table with the clipboard and scrap metal.' },
  ]},
  { skill:'SCIENCE', name:'Big Book of Science', count:8, copies:[
    { location:'Ashton Missile Silo',                 detail:'LONESOME ROAD. Launch deck, level 3 of the silo wreckage, north corner. Just past a Hard locked safe.' },
    { location:'Brewer\'s Beer Bootlegging',          detail:'Cellar, back room. On a table to the left of the chemistry set.' },
    { location:'Camp Forlorn Hope',                   detail:'Command center, southeast corner. On the desk.' },
    { location:'HELIOS One',                          detail:'Reward from Ignacio Rivas for distributing power to the entire grid in "That Lucky Old Sun".' },
    { location:'Nipton',                              detail:"Town Hall, Mayor Steyn's office. On the desk." },
    { location:'REPCONN Headquarters',                detail:'First floor, through the door next to the radioactive barrel display. On a shelf past the Hard locked door.' },
    { location:'Sierra Madre Casino',                 detail:'DEAD MONEY. On a bookshelf in Vera\'s room in the Executive suites.' },
    { location:'Y-0 Research Center',                 detail:'OLD WORLD BLUES. Corner of the canyon south of the Y-0 building. Between two xander root plants, by the hand of a skeleton.' },
  ]},
  { skill:'SNEAK', name:'Chinese Army: Special Ops Training Manual', count:8, copies:[
    { location:'Camp Searchlight',                    detail:'East church basement, against the eastern wall. At the foot of the metal shelves, on the floor.' },
    { location:'Goodsprings',                         detail:"Trudy's home. On a bookshelf, east of the schoolhouse." },
    { location:'NCR Sharecropper Farms',              detail:'Sharecropper barracks. On the corner desk, near the four water towers in the northeast corner.' },
    { location:'Puesta del Sol Switching Station',    detail:'DEAD MONEY. Easternmost room. On the catwalk on the south side of the large machine.' },
    { location:'Sunstone Tower Roof',                 detail:'LONESOME ROAD. Bookshelf facing the wall on the southeast landing (requires explosives to knock it down).' },
    { location:'Vault 3',                             detail:'Living quarters. On a shelf, down the stairs from the recreation area, through an Average locked door.' },
    { location:'X-13 Research Facility',              detail:'OLD WORLD BLUES. On the floor opposite the door, in the room with the stealth suit Mk II chest plate.' },
    { location:'X-13 Research Facility',              detail:'OLD WORLD BLUES. In the reward safe after completing all the stealth suit tests.' },
  ]},
  { skill:'SPEECH', name:'Lying, Congressional Style', count:6, copies:[
    { location:'Brooks Tumbleweed Ranch',             detail:'Upstairs room with the chessboard. On an open locker shelf.' },
    { location:'Cerulean Robotics',                   detail:'On the floor among the office desks.' },
    { location:'Lucky Jim Mine',                      detail:'In the house. On the bottom shelf below a varmint rifle.' },
    { location:'NCR Correctional Facility',           detail:'CF administration building, second floor. On a desk.' },
    { location:'The Tampico',                         detail:'DEAD MONEY. Sierra Madre. On a shelf opposite the holotape projector.' },
    { location:'Third Street Municipal Building',     detail:'LONESOME ROAD. Top floor (via the municipal sewers), easternmost corner. Under a physician\'s desk.' },
  ]},
  { skill:'SURVIVAL', name:'Wasteland Survival Guide', count:5, copies:[
    { location:'Lone Wolf Radio',                     detail:'Inside the radio trailer, near the mattress.' },
    { location:'Matthews Animal Husbandry Farm',      detail:'Top balcony of the northern barn, near the barrel crate.' },
    { location:'Mesquite Mountains Camp Site',        detail:'Inside the western tent, behind the bedding and toolbox.' },
    { location:'Scavenger Platform',                  detail:'Among the books under the fallen metal bookshelf, on the northern platform section.' },
    { location:'Waste Disposal Station',              detail:'LONESOME ROAD. In the middle of the fallen radioactive barrels, behind a skeleton draped over one of them.' },
  ]},
  { skill:'UNARMED', name:'Pugilism Illustrated', count:6, copies:[
    { location:'Fisherman\'s Pride Shack',            detail:'On the bedside table.' },
    { location:'Nipton Road Reststop',                detail:'Inside the store. Wooden shelf on the left upon entering, close to the counter.' },
    { location:'The Tops',                            detail:'Presidential suite, pool room. On the tiny table in the corner.' },
    { location:'Vault 11',                            detail:'Living quarters, first female dorm. By the fallen dresser, near a "ladies" sign on the ceiling.' },
    { location:'Villa',                               detail:'DEAD MONEY. Behind the fountain at the entrance.' },
    { location:'Wastewater Treatment Plant',          detail:'LONESOME ROAD. Northeast corner of the third room. Behind a set of tipped-over lockers.' },
  ]},
];
...
const TRAIT_BONUSES = {
    ...
    "Good Natured":              { special:{CHA:+1}, skills:{"BARTER":+5,"SPEECH":+5,"BIG GUNS":-5,"ENERGY WEAPONS":-5,"EXPLOSIVES":-5,"GUNS":-5,"MELEE WEAPONS":-5,"UNARMED":-5} },
        ...
        extra: (val) => {
            ...
            return `<div class="sinfo-companion-box">
                ...
                <div class="sinfo-companion-row">
                    <span class="sinfo-slot-val">${total}</span>
                    <span class="sinfo-slot-sub">slot${total !== 1 ? 's' : ''}${magLabel}</span>
                </div>
                <div class="sinfo-companion-thresholds">
                    <div style="opacity:0.55; font-size:0.62rem; margin-bottom:4px;">THRESHOLDS:</div>
