...
const ARCHETYPES_DATA = [
  ...
  /* ── 9. TECH SCAVENGER ──────────────────────────────────── */
  {
    ...
    startingTraits:[{name:'Educated'},{name:'Hoarder'},{name:'Night Person'},{name:'Theories and Hypothesis'}],
    traits:['','','','','','','','','','','',''],
    perks:[
  ...
  /* ── 10. MELEE SLASHER ───────────────────────────────────── */
  {
    ...
    icon:'🔪', color:'#E24B4A', origin:'CW', mode:'std', buildKarma:'evil',
    ...
    traits:['','','','','','','','','','','',''],
    perks:[
      ['That\'s Not a Knife','END 5 ✓, Melee 30 ✓, Survival 30 — gains DT vs blades'],
      ['ACTION STAR [+AP REGEN]','Rapid AP regen for relentless melee pressure'],
      ['Blunt Force Trauma','Crit chance and attack speed with blunt weapons — STR 8 ✓'],
      ['Butcher','+20% attack speed; AP and XP on cripple — Evil Karma ✓, Melee 35 ✓'],
      ['Finesse','Crit chance boost — LCK 9 post-implant devastating'],
      ['This Is A Knife','DT when guarding with blade; rank 2 speed and dmg — STR 6 ✓, AGL 7 ✓'],
      ['Piercing Strike','Negate 2 DT per STR — STR 8 = 16 DT ignored'],
      ['Unstoppable Force','4x dmg through blocks — STR 8 ✓, Melee 60 ✓'],
      ['Stonewall','+1 DT per END vs melee; immune to knockdown — END 7 ✓'],
      ['Better Criticals','3% crit dmg per PER — PER 6 ✓ with implant'],
      ['Grim Reaper\'s Sprint','Kill in BT restores AP'],
      ['Slayer','All melee attacks +20% speed — AGL 7 ✓, STR 7 ✓, Melee 70 ✓'],
      ['Chainsaw Carnage','+20% dmg with auto melee; kill = +10 DT + time slow — Butcher ✓'],
      ['Ninja','+15% crit chance melee; sneak attack crits +25% — Melee 80 ✓'],
      ['Fatal Counter','2x dmg and crit when target staggered — Melee 75 ✓'],
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
      _EMPTY_PERK_SLOT,
  ...
  /* ── 11. BIG GUNS HEAVY ──────────────────────────────────── */
  {
    ...
    icon:'🔥', color:'#BA7517', origin:'MW', mode:'std', buildKarma:'very-good',
  ...
  /* ── 12. CANNIBAL SURVIVOR ───────────────────────────────── */
  {
    ...
    icon:'🦴', color:'#5DCAA5', origin:'CW', mode:'std', buildKarma:'neutral',
  ...
  /* ── 13. PUMP-ACTION RANGER ──────────────────────────────── */
  {
    ...
    icon:'🎯', color:'#97C459', origin:'MW', mode:'std', buildKarma:'good',
  ...
  /* ── 14. DESERT COWBOY ───────────────────────────────────── */
  {
    ...
    icon:'🤠', color:'#EF9F27', origin:'MW', mode:'std', buildKarma:'good',
  ...
  /* ── 15. WASTELAND SNIPER ────────────────────────────────── */
  {
    ...
    icon:'🔭', color:'#B5D4F4', origin:'CW', mode:'std', buildKarma:'evil',
